...
\CondRule{E10}{  %% Subtypecast
  \BasicType {\tp \Sub \t;~\tp} {\tp \Sub \t} $~\vee~$ \t $= \any$, \textit{s.t.} $\tp = \classof\a\s\K$
}{ 
...
\IRule{SRec}{
 \BasicType {\M{M;~N,~N'}} {\mt\Sub\mt'}\\
 \BasicType {\M{M;~N,~N'}} {\Type{ \b{\mt_1}} \Sub \Type{\b{\mt_2}}}
}{
 \BasicType {\M{M;~N,~\texttt{\mt}',~N'}} {\Type{\mt~\b{\mt_1}\,} \Sub
  \Type{\mt'~\b{\mt_2}\,}} 
}

\IRule{SMeth}{
   \BasicType {\MNargs{~\t_2 \Sub \t_1}{\t_1}} {\t_2 \Sub \t_1} \\ \BasicType {\MNargs{~\t_1' \Sub \t_2'}{\t_1'}} {\t_1' \Sub \t_2'} 
}{
