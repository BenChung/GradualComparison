...
\IRule{A5}{
    \GenCast{\K}{\E}{\e_1}{\e_3}{\C} \\ \n(\b{\t_1}):\ba\D \in \classoff\C\K \\ \b{\AnaCast{\K}{\E}{\e_2}{\e_4}{\t_1}} 
}{
    \GenCast{\K}{\E}{\Call{\e_1}\n{\b{\e_2}}}{\SubCast{\D}{\DynCall{\e_3}\n{\b{\e_4}}}}{\bC} %Q: do I need to cast the return value of non-bang
}

\IRule{A6}{
    \GenCast{\K}{\E}{\e_1}{\e_3}{\C} \\ \n(\b{\t_1}):\t_2 \in \classoff\C\K \\ \t_2 \neq \ba\D \\ \b{\AnaCast{\K}{\E}{\e_2}{\e_4}{\t_1} }
}{
    \GenCast{\K}{\E}{\Call{\e_1}\n{\b{\e_2}}}{\DynCall{\e_3}\n{\b{\e_4}}}{\C} %Q: do I need to cast the return value of non-bang
}

\IRule{A8}{
    \GenCast{\K}{\E}{\e_1}{\e_3}{\any} \\ \b{\AnaCast{\K}{\E}{\e_2}{\e_4}{\any}}
}{
    \GenCast{\K}{\E}{\Call{\e_1}\n{\b{\e_2}}}{\DynCall{\e_3}\n{\b{\e_4}}}{\any}
}
