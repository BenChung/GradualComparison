...
&\B e + e\B \xt{x}\B \NEW \C {\bar{e}} \B  \cast{\t}e \B \scast{\m}e\\
r &::= e \B \error\\
...
\newcommand{\TApp}{\inferrule*[lab=TApp]{ \GSdash e_r : \C \\ \m(\bar{\t'}):\t'' \in \C \\ \GSdash e': \t'}{\GSdash e_r.\m(\bar{e'}) : \t''}}
...
\newcommand{\CICallAny}{\inferrule*[lab=CICallAny]{ 
  ...
  \Gdash e.\m(\bar{e'}) \tlate (\scast{\m_u}e'').\m_u(\bar{e'''}) : \any
}}
