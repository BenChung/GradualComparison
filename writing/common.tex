...
\IRule{RC1}{
  ...
  \b{\rectype{\meet\Sigma{\ap:\t},\Omega,\sigma,\ap,\t_f} = \Omega~\Omega''}
}
...
\begin{mathpar}
\IRule{M1}{ }{\Phi~\Omega~\K \vdash\meet{\t}{\any} \equiv \t\dashv\Phi}

\IRule{M2}{ }{\Phi~\Omega~\K \vdash\meet{\any}{\t} \equiv \t\dashv\Phi}

\IRule{M3}{ }{\Phi~\Omega~\K \vdash\meet{\t}{\t} \equiv \t\dashv\Phi}
...
\IRule{M7}{
  \meet{\C}{\D} \not\in \text{dom}(\Phi)\\
  \Phi~\meet{\C}{\D}={\Mxt E}~\Omega~\K \vdash \meet{{\text{typeof}}(\C)}{{\text{typeof}}(\D)} \equiv \t \dashv \Omega'
}{
