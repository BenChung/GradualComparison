...
\renewcommand{\d}{\ensuremath{\xt{d}}}
\newcommand{\is}{\mapsto}
%% Cast syntax??
...
\newcommand{\context}{\G &::= \cdot \B \xt{x} : \tau~\G\\}
\newcommand{\casterror}{\text{casterror}}
\newcommand{\syntax}{
\begin{align*}
\t &::= \types\\
e &::= n \B  e.\m(\bar{e}) \B e.\f \B e.\f  = e \B  \ifthenelse{e}{e}{e} \\
&\B e + e\B \xt{x}\B \NEW \C {\bar{e}} \B  \cast{\t}e\\
\cl &::= \CLASS \C {\bar \D} { \bar{ \f : \t }, ~ \bar{ \MDEF{d}{\bar{\xt{x} :\t}}{\t'}{e} } } \\
d &::= \m \B \f \B f!\\
r &::= e \B \casterror \\
\context
v &::= n \B a\\
\s &::= \cdot \B  \s( a \is \{\bar{\f=v} \B \C\} )\\
F &::=    \square.\f
   \B     \square.\f = e
   \B     a.\f = \square    
   \B     \square.\m(\bar e) 
...
\newcommand{\TUApp}{\inferrule*[lab=TUApp]{\bar{\GSdash e_i : \t_i} \\ \GSdash e : \any}{\GSdash e.\m(\bar{e_i}) : \any}}
\newcommand{\TApp}{\inferrule*[lab=TApp]{ \GSdash e : \C \\ \m(\bar{\t'}):\t'' \in \C \\ \GSdash e': \t'}{\GSdash e.\m(\bar{e'}) : \t''}}
