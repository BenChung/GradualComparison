...
\CondRule{E5}{
  \cast{\ap1}{\t}{\ts}{\sp1}{\cbp1} = \e, \sp2, \cbp2
}{ 
    \ReduceA{\cb_1}{\CastS{\tp 1}{\ts}{\ap1}}{\sp1}{\cb_2}{\e}{\sp2}
}
\CondRule{E6}{
  \cast{\a}{\t}{\ts}{\sp1}{\cb} = \err
}{ 
    \ReduceA{\cb}{\CastS{\tp 1}\ts\a}\s\err{}{}
}
\CondRule{E7}{
...
\begin{mathpar}
\IRule{Cast-Wrap}{\xt{D}\;\text{\emph{free}} \\ \s[\a \mapsto \{ \a' \ldots \B \C \}] \\ \cbp2 = \cbp1;\wrapper{\C \Rightarrow \t,\xt{D}}}{\cast\a{\t}{\xtns{b}}\s{\cbp1} = \New{\xt{D}}\a, \s, \cbp2}
...
\IRule{Cast-Mono1 (monotonic)}{
  ...
  \cast{\ap1}{\tp1}{\xtns{m}}{\sp1}\cb = \ap1, \s'_n, \cb'\\
}
...
\IRule{Cast-Mono2 (monotonic)}{
  ...
  \cast{\ap1}{\tp1}{\xtns{m}}{\s}\cb = \ap1,\s,\cb\\
}

\IRule{Cast-Check (concrete)}{\Heap\s{\Bind\a{\Obj{\a_1,\ldots}{\C}}} \\ \C <: \tp2 }{\cast\a{\tp2}{\xtns{c}}\s\cb = \a, \s, \cb}

\IRule{Cast-Any (star)}{ }{\cast\a{\any}{_}\s\cb = \a, \s, \cb}

\IRule{Cast-Error}{ }{\cast\a{\t}{_}\s\cb = \err}
\end{mathpar}
