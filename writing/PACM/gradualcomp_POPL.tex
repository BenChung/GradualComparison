...
\\
\K\HS{\KCall\a\m\ap\t\tp} \> \s      \>\Red\>     \K \>  \ep \> \s \> \WHERE\> \ep = {[\a/\this~{\ap/\x}]\e} \HS \> \Mdef\m\x\t\tp\e\In \App\K\C  \\ \> \> \> \> \> \> \>  \App\s\a=\obj\C{\a[1]..}
\\
...
\begin{minipage}{1.20cm}\begin{mathpar}  
 \Rule{STG-VAR}{
    ~\\\\  ~\\\\ ~\\\\
   \HasType \Env\x\t
 }{
...
\end{mathpar}
\end{minipage} &
  \begin{minipage}{2.85cm}\begin{mathpar}  
\Rule[width=12em]{STG-SET}{ ~\\\\
  %\HasType \Env\this\C \quad
  {\Fdef\f\t \in \App\K{\Env(\this)}} \\\\
  \EnvTypeS \Env\K\e\tp \\\\
  \ConvertE\K{s}\tp\t
}{
...
\end{mathpar}
\end{minipage} & 
  \begin{minipage}{1.85cm}\begin{mathpar}  
  \Rule{STG-CALL}{
   ~\\\\ ~\\\\
...
\end{mathpar}\end{minipage}&\begin{minipage}{2.0cm}\begin{mathpar}  
\Rule{STG-NEW}{~\\\\
