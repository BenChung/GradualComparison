...
\newcommand{\mdps} [1] {\EM{\md'_{#1}}}
\newcommand{\mdpps}[1]  {\EM{\md''_{#1}}}
\newcommand{\mdppps}[1]  {\EM{\md'''_{#1}}}
\newcommand{\mt}  {\EMxt{mt}}
\newcommand{\mtp}  {\EMxt{mt'}}
\newcommand{\mtpp}  {\EMxt{mt''}}
\newcommand{\mts}[1]  {\EMxt{mt_{#1}}}
\newcommand{\mtps}[1]  {\EMxt{mt'_{#1}}}
\newcommand{\mtpps}[1]  {\EMxt{mt''_{#1}}}
\newcommand{\M}{\EM{\mu}}
\newcommand{\f}   {\EMxt f}
\newcommand{\fp}   {\EMxt{ f'}}
...
\newcommand{\behcast}[7]{\EM{#5\,#6\,#7 = \xt{behcast}(#1, #2, #3, #4)}}
\newcommand{\behcastE}[7]{\EM{\xt{behcast}(#1, #2, #3, #4) = #5\,#6\,#7}}
...
\newcommand{\EnvTypex}[5]{ \EM{#1\,#2\,#3\vdash_x #4 : #5}}
...
\newcommand{\GenType}[4]{#1~#2 \vdash #3 \Uparrow #4}
\newcommand{\AnaType}[4]{#1~#2 \vdash #3 \Downarrow #4}

\newcommand{\Convertible}[3]{\EM{#1 \vdash #2 \Mapsto #3}}
\newcommand{\ConvertE}[4]{\EM{#1 \vdash_{#2} #3 \Mapsto #4}}
...
\newcommand{\EnvTypeW}[4]{ \EM{#1\,#2\vdash_{th} #3 : #4}}
\newcommand{\EnvTypeS}[4]{ \EM{#1\,#2\vdash_{s} #3 : #4}}
\newcommand{\EnvTypeT}[4]{ \EM{#1\,#2\vdash_{tr} #3 : #4}}
\newcommand{\EnvTypeE}[5]{ \EM{#1\,#2\vdash_{#3} #4 : #5}}
...
\newcommand{\WFx}[4]{\EM{#1\,#2\,#3\vdash_{x}~#4 \OK}}
\newcommand{\WFX}[5]{\EM{#1\,#2\,#3\vdash_{#5}~#4 \OK}}
\newcommand{\WFtypex}[2]{\EM{#1\vdash_{x}~ #2 \OK}}
\newcommand{\WFtypeX}[3]{\EM{#1\vdash_{#2}~ #3 \OK}}

\newcommand{\WFtypeW}[2]{\EM{#1\vdash_{th}~ #2 \OK}}
\newcommand{\WFW}[3]{\EM{#1\,#2\vdash_{th}~#3 \OK}}
