...
\newcommand{\GenCast}[5]{#1~#2 \vdash #3 \hookrightarrow \src{~#4~} \Uparrow #5} 
...
\newcommand{\classtrans}[3]{\src{#1 \vdash #2 ~\hookrightarrow_c} ~#3}
\newcommand{\methtrans}[5]{\src{#1~#2 \vdash #3 ~\hookrightarrow_m} ~#4~#5}
