...
\begin{enumerate}
  \item The program is already fully evaluated. Since \kafka has only one value,
  ...
  \item The program can take a step. In this case, the program will
...
\verb|retains_references|) and class table \verb|k| (expressed using \verb|ct_ext|).
  ...
  \item The program could be stuck at a dynamic call expression. T
  ...
  \item The program could have gotten stuck on a subtype cast. 
  ...
  \item The program may get stuck on a behavioral cast, of the form
