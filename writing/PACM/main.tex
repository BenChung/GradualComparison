...
have different notions of what constitutes an erroneous program.
Understanding why a program fails with a runtime error is something that
...
according to the semantics of Section 4. Each program consist of a class
...
checking requires \A to be a subtype of \xt I, however in this case, \xt Q
...
\C being casted to \xt E, despite \C not being a subtype of \xt E.  Just as
