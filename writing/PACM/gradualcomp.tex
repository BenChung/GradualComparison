...
\IRule[width=20em]{STG-CALL}{
  ...
  \EnvTypeS \Env\K{\Call\e\m\ep}\tpp
}    

\IRule{STG-NEW}{
 \EnvTypeS \Env\K{\e_1}{\t_1}~~\dots~~ 
 \EnvTypeS \Env\K{\e_n}{\t_n}\ \\ 
 \b\fd=\Fdef{\f_1}{\t_1}~\dots~\Fdef{\f_n}{\t_n} \\ 
  \Class \C {\b\fd}{\b\md} \in \K
}{
...
\IRule[width=20em]{STT-CALL}{
  ...
  \EnvTypeT \Env\K{\Call\e\m\ep}\tpp
}    

\IRule{STT-NEW}{
 \EnvTypeT \Env\K{\e_1}{\t_1}~~\dots~~ 
 \EnvTypeT \Env\K{\e_n}{\t_n}\ \\ 
 \b\fd=\Fdef{\f_1}{\t_1}~\dots~\Fdef{\f_n}{\t_n} \\ 
  \Class \C {\b\fd}{\b\md} \in \K
}{
...
TTR6 \TRG{\New\C{\e_1..}}\Env\> = \src{\New\C{\eps 1..}} 
     \>\WHERE\HS    \Ftype{\f_1}{\t_1}\In\C, \HS  \eps 1 = \TAG{\e_1}\Env{\t_1} ..
\\[1mm]
TTR7 \TAG\e\Env\t\> = \src\ep \> \WHERE\HS  \EM{\K\vdash\kty\tp \Sub \kty\t}, \TypeCk{\K,\E}\e\tp, \ep = \TRG\e\Env
\\[1mm]
...
\begin{lemma}{Soundness of compatibility}{THT-COMP}
  ...
  \end{conds}
  \then\axiom{$\EnvType\Envp\cdot\Kp{\TAG\e\Env{\kty\tp}}{\kty\tp}$}
\end{lemma}
...
\begin{lemma}{Type correctness of Thorn translation}{THT-TRANS}
  ...
  \begin{proof} \indmsg{\EnvTypeW\Env\K\e\t}
    ...
    \begin{case}{STH-SET}
      ...
      \step{$\Compatible\K\tp\t$}{case}\lbl{TSSLC}
      ...
      \slet{\epp}{{\TAG\e\Env{\kty\t}}}\lbl{TSSA2}
