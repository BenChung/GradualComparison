...
\IRule[width=20em]{TSS4}{
    {\HasType{\Env}\this\C} \\ {\f(\b{\t_1}):\t_2 \in \classoff\C\K} \\ {\AnaCast\K\Env{\e}{\ep}{\t_1}}
}{
    \GenCast\K\Env{\Call{\this}\f{\e}}{\Call{\this}\f{\ep}}{\any}
}
...
\\
\SPP \Mdef\m\x\t\tp {~\bscast\tp{{\Call{\Get\this\that} \m {\bscast{\Cp}\x} }}~}
...
\\
\SPP \Mdef\m\x\t\tp{~\bscast\tp{\Call{\Get\this\that} \m {\x} }~}
  ...
  \begin{proofy}
    ...
    \begin{casel}
      ...
      \begin{proofy}
        ...
        \stepp[wcorr] Let $\k$ be $\k = \wrap\C{\getmds\C\K}{\classoff\C\K}{\classoff\Cp\K}\D$.
      ...
      \begin{proofy}
        \stepp Let $\D$ be fresh.
        \stepp Let $\ap$ be fresh.
        \stepp[wcorr2] Let $\k$ be $\k = \wrapAny\C{\getmds\C\K}{\classoff\C\K}\D$.
        \stepp Let $\sp = \s[\ap \mapsto \D\{\a\}]$.
...
\subsection{Wrap function creates well-formed classes}
  ...
  \begin{conds}
   ...
   \cond{k = \wrap\C{\getmds\C\K}{\classoff\C\K}{\classoff\Cp\K}\D}\lbl{cond4}
  \end{conds}
