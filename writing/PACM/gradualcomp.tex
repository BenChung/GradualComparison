...
because method \(o\) does not exist, the second is erroneous as it
...
%
\noindent
The TypeScript type system is reported in \figref{f:typescriptts}.  

The auxiliary relation of \emph{convertibility}, denoted   \ConvertE\K{s}\t\tp, captures all ...


\FZ{EXPLAIN CONVERTIBILITY + RULES} Well-typed code is translated to plain JavaScript with all types erased and methods resolved dynamically. 
