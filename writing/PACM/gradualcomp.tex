...
\newpage
\begin{verbatim}
tc( class C { fd1.. md1.. }  ) =  class C { fd1'.. md1'.. md1''.. md1'''.. } 
      where fd1 = f:t,  fd1 = f:*, 
                        md1''=  f():*{this.f} ,  
                        md1'''=[f(x:*):*{this.f=x}
                        .. 
...
tc(K, class C { fd1.. md1.. }) = class C { fd1.. md1'.. md1''.. md1'''.. md1''''}
     where  fd1 = f:t, 
          md1'' = f(}:t { this.x } 
          md1'''=  f(x:t):t { this.f = x } ..
           md1  =  m(x:t1):t2 { e  } ,
           md1' =  m(x:t1'):t2' { e' }  
            t1' =  C  if t1 ==  C 
                =  *  otherwise
         ...
         md1''' =  m(x:*):* { <t2>this.m(<t1>x) }

te(K, T, this.f    =  this.f() 
te(K, T, e.f )     =  e'@f()   where e' = te(K, T,  e),  K,T |- e : * or ?C
te(K, T, e.f )     =  e'.f()   where e' = te(K, T,  e),  K,T |- e : C
te(K, T, this.f=e) =  this.f( e' )  
         where e'' = te(K, T,  e )
               T   = this:C ..
               f:C' in C
               e'  = e''     if K,T |- e : C'
...
te(K, T,  e1.m(e2) )   =  e1'.m(e2')   
         where K,T |- e1 : C
               ...
               e2' =  e2''  t' <: t
                   = <t>e2'' otherwise
te( new C(e1..) ) =  new C(e1'..)   where e1' = te(K,T,e1 )..
\end{verbatim}
...
\opdef{$\fieldtrans {\fd}{\fd'}{\K}$}{TypeScript translation for fields} 
...
\opdef{$\fieldtrans {\fd}{\fd'}{\K}$}{Thorn translation for fields} 
\begin{mathpar}
...
\IRule[width=25em]{TH-METHODANY}{
  ...
  \src{\t[3]} = \Kt{\t[1]} \\ \src{\t[4]} = \Kt{\t[2]} \\ 
  \src{\t[3] = \t[4] = \any}
}{
  \methtrans {\K}{\C}{\Mdef\m\x{\t[1]}{\t[2]}{\e}}{\Mdef\m\x{\t[3]}{\t[4]}{\ep}}{}
}
...
&     \Mtype\m\Cp\Cpp\in\bmtp ~\wedge~ \Mtype\m\t\tp\in\bmt \\
\\
\SPP \Mdef\m\x\t\tp{~\bscast\tp{\Call{\Get\this\that} \m {\x} }~}
&    \Mtype\m\any\any\in\bmtp ~\wedge~ \Mtype\m\t\tp\in\bmt \\
% \\
% \SPP \Mdef\m\x\any\any {~\BehCast\any{\Call\this\m{\bscast{\t}\x}}~}
% &     \Mtype\m\Cp\Cpp\in\bmt  ~\wedge~ \Mtype\m\t\tp\in\bmtp \\
% &\multicolumn{5}{l}{~\wedge~\Mtype\m\any\any\not\in\bmt ~\wedge~\t\neq\any} \\
\\
