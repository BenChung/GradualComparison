...
\rc e{\K, ~\Env, ~\SubCast{\C}{\e}} = \e 
     \HS\IF ~ \TypeCk{\K,\Env}{\e}\D, \HS \StrSub\emptyset\K\D\C 
\\[2mm]
...
\\[2mm]     
\rc e{\K, ~\Env, ~\SubCast{\any}{\e}} = \e \HS \IF ~  \TypeCk{\K,\Env}{\e}\any 
\\[2mm]
\rc e{\K, ~\Env, ~\SubCast{\any}{\e}} = \SubCast{\any}{\e} \HS \IF ~ \TypeCk{\K,\Env}{\e}\C 
\end{tabbing}
\end{minipage}
\end{tabular}
