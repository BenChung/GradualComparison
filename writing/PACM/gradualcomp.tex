...
\begin{center}
\begin{tabbing}
  \K~ \New\C{\b\a} \HS\HS\HS\= \s~ \HS \=\Red\HS \= \K \HS\= \ap \HS\HS\= \sp\HS \= \WHERE\HS\= \fresh\ap \HS\HS\HS\HS\HS\HS\HS\=  \sp = {\Map\s{\Bind\ap{\obj\C{\a_1..}}}}
\\
\K ~ \FReadR\a{\f_i} \> \s           \>\Red\>     \K \>$\a_i$ \> \s  \> \WHERE \>\App\s\a=\obj\C{\a_1..\a_i..}
\\
\K ~ {\FWriteR\a{\f_i}\ap} \> \s     \>\Red\>     \K \> \ap \> \sp \>  \WHERE \>\App\s\a=\obj\C{\a_1..\a_i..} \HS  \> \sp = \Map\s{\Bind\a{\obj\C{\a_1..\ap..}}}
\\
\K ~ {\KCall\a\m\ap\t\tp} \> \s    \>\Red\>     \K \>  \ep \> \s \> \WHERE\> \ep ={[\a/\this~{\ap/\x}]\e} \HS \> \Mdef\m\x\t\tp\e\In \App\K\C  \HS  \App\s\a=\obj\C{\a_1..}
\\
 \K ~ {\DynCall\a\m\ap}\> \s        \>\Red\>    \K \> \ep \> \s \>  \WHERE\> \ep = {[\a/\this~{\ap/\x}]\e}\HS \> \Mdef\m\x\any\any\e \In \App\K\C \HS \App\s\a=\obj\C{\a_1..}
\\
 \K ~ {\SubCast \any\a} \> \s       \>\Red\>   \K \> \a \> \s
\\
 \K ~ {\SubCast \D\a} \> \s        \>\Red\>    \K \> \a \> \s \>  \WHERE\> \StrSub {}\K\C \D \>\App\s\a=\obj\C{\a_1..} 
\\
