...
TypeScript~cite{}, Thorn~\cite{}, Typed Racket~\cite{}, and the Transient
variant of Reticulated Python~\cite{}.  We focus on the core features of
these four systems, namely the typing of objects, and explain what errors
are caught statically and which errors are caught dynamically. We
demonstrate that these system have different notions of ``soundness''.
