...
\subsection{Wrap function creates well-formed classes}
  ...
  \begin{conds}
   ...
   \cond{k = \wrap\C{\bmt}{\bmtp}\D}\lbl{cond4}
  ...
  \then\axiom{\WF{}\sp{\K~\k}{\k}}
    ...
    \begin{proof} \innatE{on the definition of the \xt{wrap} function}
     ...
     \begin{case}{\xt{overloading}$_{\cmd}$(\b\md~\b\fd)}\lbl{N}
      \step{Trivial}{\textbf{that} is fresh and \bylemm{\ref{lem:DM-OL}}{DupMeth gives overloading}{\trf{cond7}}}\lbl{N1}
     \end{case}
    \end{proof}
   \end{theorem}


\begin{lemma}{DupMeth gives overloading}{DM-OL}

  \begin{conds}
  \cond{$\Class \C {\b\fd}{\b\md} \in \K$}\lbl{cond3}
  \cond{\bmt = \classoff\C\K}\lbl{cond2}
  \cond{\cload{\bmt}}\lbl{cond1}
  \end{conds}
