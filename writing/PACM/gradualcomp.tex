...
The type system of Typed Racket is analogous to that of TypeScript, already reported in~\figref{f:typescriptts}.  However, contrarily to TypeScript, Typed Racked  ensures
that values passing a typed/untyped boundary are consistent with their
declared types.  This enforcement mechanism constitutes the core of any gradual typing system:
 Thorn handled this problem through the use of \emph{concrete}
