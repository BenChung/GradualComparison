...
\\[3mm]
  \wrapAny{\C}{\mds 1..}{\D}{\that} = \src{\Class \D{ \Fdef\that\C}{ \mds 1..}}\\
...
\begin{equation*}
  \behcastE\a\Cp\s\K \Kp\ap\sp ~~\WHERE~~ \begin{cases}
  \App\s\a = \obj\C{\a_1..} \HS\HS
  \fresh{\D,\ap,\that} \HS\HS
  \mds 1.. = \App\K\C \qquad \mdps 1.. = \App\K\Cp \\
  \names{\mds 1..} \subseteq \names{\mdps 1..} \HS\HS
...
\begin{equation*}
  \behcastE\a\any\s\K \Kp\ap\sp  ~~\WHERE~~ 
  \App\s\a = \obj\C{\a_1..} \HS \mds 1.. = \App\K\C \HS
  \fresh{\D,\ap,\that} \HS
  \Kp = \K\,\wrapAny\C{\mds 1..}\D\that \HS
  \sp = \Map \s{\Bind\ap{\obj\D{\a}}} 
\end{equation*}
