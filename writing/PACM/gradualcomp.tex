...
\begin{tabbing}
  \wrap{\C}{\mts 1..}{\mtps 1..}{\D}{\that} = \src{\Class \D{ \Fdef\that\C}{ \mtpps 1..}}\\
\HS\HS\WHERE\HS\=\mtpps 1 = \src{ \Mdef\m\x{\tp_1}{\tp_2}{~\BehCast\tppp{ \KCall{\FRead\that} \m {\bscast{\t_1}\x}{\t_1}{\t_2}} } }   ..
    \HS \= \textbf{if} \HS \Mtype\m{\t_1}{\t_2}\In\mts 1.. \HS\HS \Mtype\m{\tp_1}{\tp_2}\In\mtps 1.. \\
\\[-3mm]
\> \EM{\mtpps 1} =  \src{\Mdef\m\x{\t}{\tp}{~\KCall{\FRead\that}\m{\x}\t\tp~}} ..
...
\begin{lemma}{Type correctness of Transient translation}{THTA-TRANS}
  ...
  \begin{proof} \indmsg{\EnvTypeW\Env\K\e\t}
    ...
    \begin{case}{STT-CALL}
      ...
      \slet{$\epp_2$}{$\TAG{\ep_1}\Env\t$}\lbl{STTCall4}
