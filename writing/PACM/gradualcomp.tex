...
\begin{array}{@{}ll@{}l@{}r@{~}c@{~}r}
  \wrap{\C}{\mt_1..}{\mtp_1..}{\D}{\that} = \src{\class ~ \{ \Fdef\that\C \mtpp_1.. \} }\\
  \WHERE  \mtp = \src{ \Mdef\m\x\tpp\tppp {~\bscast\tppp{{\KCall{\FRead\this\that} \m {\bscast{\t}\x}\t\tp }}~}}
...
\begin{lemma}{Type correctness of Transient translation}{THTA-TRANS}
  ...
  \begin{proof} \indmsg{\EnvTypeW\Env\K\e\t}
    ...
    \begin{case}{STT-SET}
      ...
      \step{$\EnvType\Envp\cdot\Kp{\SubCast\t{\FWrite\f{\ep_2}}}\any$}{\RuleRef{KT-SUBCAST} on \trf{STTSet8}}\lbl{STTSet9}
    \end{case}
