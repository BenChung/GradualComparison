...
Gradual typing has matured beyond being an experimental language 
feature in the petri dish of language research in academia, and
applications are now written with languages incorporating 
gradual types.   However the proposed designs are subtle and differ in corner behaviours: 
it is the responsibility of language researchers to gain a clear picture of each approach to gradual typing. 

In this paper we introduced \kafka, a formal language that serves as the foundation
for deconstructing several existing gradual typing systems: Typescript, Thorn,
Transient Python, and Typed Racket.
\kafka offers an opportunity to compare and contrast each gradual typing system
within an unified framework. The strength of \kafka lies in its simplicity and in the flexibility provided by its casts and
wrapper generation.

\FZ{I would remove this last sentence.} A big takeaway from constructing \kafka is understanding that gradual typing systems
...
%There does not seem to be any right answer or 
...
is inherited of its declared type. In \kafka this manifested itself as the types
...
%
%New gradual typing systems can be introduced via a new cast semantics.
