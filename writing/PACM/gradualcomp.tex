...
\begin{array}{r@{~}l}
\readf \s\a\f\K &= \ap\\ 
    ~~\mathit{if}~~ &\s(\a) = \obj\C{\a_1\dots\a_n \ap \dots}\\
    ~~\mathit{and}~~ &\Class\C {\Fdef{\f_1}{\t_1}\dots\Fdef{\f_n}{\t_n}\Ftype\f\t\dots}{\b\md}\in\K \\
\setf \s\a\f\ap\K &= \Map\s{\Bind{\a}{\obj\C{\a_1\dots\a_n\,\ap\dots}}}\\
  ~~\mathit{if}~~ &\s(\a) = \obj\C{\a_1\dots\a_n\,\app\dots} \\
  ~~\mathit{and}~~&\Class\C{\Fdef{\f_1}{\t_1}\dots\Fdef{\f_n}{\t_n}\,\Fdef\f\t\dots}{\b\md}\in\K
\end{array}
\]
\medskip
\begin{minipage}{14cm}\begin{tabular}{l@{~~}l@{~}l@{~}l@{~}l@{~}l@{~}l@{~}l}
...
\\[1mm]
\tr a{\K, \Env, \t, \e} = \src\ep\\
\> \WHERE \> \kty\tp \Sub \kty\t, \TypeCk{\K,\E}\e\tp, \ep = \tr e{\K,\Env,\e}
\\[1mm]
...
\tr e{\K,\Env,\Call\this\f{}}  = \src{\SubCast\t{\Call\this{\namet\f\any}{}}}\\
   \>           \> \TypeCk{\K,\Env}\this\C,\HS  \Ftype\f\t\IN\C
\\[1mm]
\tr e{\Call\this\f\e} =  \src{\SubCast\t{\Call\this{\name\f\any\any}\ep}} \\
   \>\WHERE \> \TypeCk\K\this\C, \HS \Ftype\f\t\IN\C,\HS \ep = \tr a{\K,\Env,\any,\e}
\\[1mm]
...
\HS   \=\WHERE\HS \= \TypeCk{\K,\Env}{\e_1}\C, \HS \Mtype\m\t\tp\IN\C\\
   \>       \> \eps 1 = \tr e{\K,\Env,\e_1},\HS \eps 2 = \tr a{\K,\Env,\any,\e_2}
\\[1mm]
\tr e{\New\C{\e_1..}} =  \src{\New\C{\eps 1..}}\\
   \>\WHERE \> \Ftype{\f_1}{\t_1}\IN\C ~..\\
   \>       \>  \eps 1 = \tr a{\K,\Env,\t_1, \e_1} ~..
\\[1mm]
\tr a{\K,\Env,\t,\e} = \src{\SubCast\t\e}\\
   \> \WHERE     \> \TypeCk{\K,\Env}\e\tp, \HS (\t = \any \OR \tp = \any)\\
   \>            \> \ep = \tr e{\K,\Env,\e}
\\[1mm]
\tr a{\K,\Env,\t,\e} = \src\ep\\
   \> \WHERE     \> \TypeCk{\K,\Env}\e\tp, \HS (\t \Sub \tp \OR \consistent\K\t\tp)\\
   \>            \>  \ep = \tr e{\K,\Env,\e}
\end{tabbing}
\end{minipage}
\end{tabular}
...
\\[1mm]
\tr e{\K,\Env,\Call\e\f{}}  = \src{\Call\ep{\namet\f\t}{}}\\
   \> \WHERE    \> \TypeCk\K\Env\e,  \HS \Mtype\f{}\t,\HS  \ep = \tr e{\K,\Env,\e}
\\[1mm]
\tr e{\Call{\e_1}\f{\e_2}} =  \src{\Call\this{\name\f\any\any}\ep} \\
   \>\WHERE \> \TypeCk\K\this\C, \HS \Ftype\f\t\IN\C,\HS \ep = \tr a{\K,\Env,\t,\e}
\\[1mm]
\tr e{\Call{\e1_1}\m{\e_2}} = \src{\DynCall{\eps 1}{\name\m\any\any}{\eps 2}}\\
   \>\WHERE \> \TypeCk{\K,\Env}{\e_1}\any, \HS  \eps 1 = \tr e{\K,\Env,\e_1},\HS \eps 2 = \tr a{\K,\Env,\any,\e_2}
\end{tabbing}
...
\begin{minipage}{8cm}  
\begin{tabbing}
\tr e{\Call{\e1_1}\m{\e_2}} = \src{\SubCast\t{\Call{\eps 1}{\name\m\any\any}{\eps 2}}}\\
\HS   \=\WHERE\HS \= \TypeCk{\K,\Env}{\e_1}\C, \HS \Mtype\m\t\tp\IN\C\\
   \>       \> \eps 1 = \tr e{\K,\Env,\e_1},\HS \eps 2 = \tr a{\K,\Env,\any,\e_2}
\\[1mm]
\tr e{\New\C{\e_1..}} =  \src{\New\C{\eps 1..}}\\
...
\end{minipage}
\end{tabular}
\caption{Tryped Racket}\end{figure}
