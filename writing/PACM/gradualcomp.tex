...
so we report in Fig.~\ref{f:staticsem} only the subtype rule for classes and the type rules for method calls and casts.
The complete
...
subtyping: the environment \M keeps track of the set of subtype relations assumed.  
Its only distinctive feature is that fields
appears in the type signature as getter/setter pairs with the exception of
the \that field that is hidden from the class type signature. 
...
%\noindent 
%The type judgments, \EnvType\Env\s\K\e\t, are mostly
%unsurprising, and . 
...
%the \that field that is hidden from the class type signature. 
%
% The set of subtype relations can be omitted if its empty.
...
\> \WHERE   \> \ep = \tr a{\K, \Env, \kty\t, \e}, \HS  \TypeCk{\K, \Env}\this\C, \HS  \Ftype\f\t\IN\C 
\end{tabbing}
\end{minipage}
&~~ \hspace{1cm} ~~~ &
\begin{minipage}{5cm}
...
\tr e{\K, \Env,  \Call{\e_1}\f{\e_2}} = \src{\Call{\eps 1}{\name\f\t\t}{\eps 2}} \\
      \> \WHERE   \> \TypeCk{\K, \Env}{\e_1}\C, \HS  \Ftype\f\t\IN\C \\
...
\tr e{\K,\Env, \Call{\e_1}\m{\e_2}} = \src{\Call{\eps 1}{\name\m{\t_1}{\t_2}}{\eps 2}} \\
     ...
     \>          \>  \ \Mtype\m{\t_1}{\t_2}\IN \C, \HS  \eps 2 = \tr a{\K, \Env, \t_2, \e_2} 
\\[1mm]
\tr e{\K, \Env, \New\C{\e_1..}} = \src{\New\C{\eps 1..}} \\
     \> \WHERE   \>  \Ftype{\f_1}{\t_1}\IN\C, \HS  \eps 1= \tr a{\K,\Env,\t_1,\e_1} ..
\\[1mm]
\tr a{\K, \Env, \t, \e} = \src\ep\\
\> \WHERE \> \kty\tp <: \kty\t, \TypeCk{\K,\E}\e\tp, \ep =\tr e{\K,\Env,\e}
\\[1mm]
\tr a{\K, \Env, \t, \e} = \src{\SubCast\t\ep}\\
\> \WHERE \> not \kty\tp <: \kty\t, \TypeCk{\K,\E}\e\tp, \ep =\tr e{\K,\Env,\e}
\end{tabbing}
\end{minipage}
\end{tabular}
...
\HS\= \WHERE\HS \= \mdsp 1 = \tr m{\K, \Ftype\this\C, \mds 1} ..\\[1mm]
\tr m{\K,\Env, \Mdef\m\x\t\tp\e} = \src{\Mdef\m\x\any\any{\SubCast\t\x ~; ~\ep}}\\
   \> \WHERE    \> \ep = \tr a{\K,\Env\;\Ftype\x\t,\tp,\e}
\\[1mm]
\tr e{\K,\Env, \x} = \src{\SubCast\t\x}\\
   \> \WHERE    \> \TypeCk{\K,\Env}\x\t
\\[1mm]
\tr e{\K,\Env,\Call\this\f{}}  = \src{\Call\this{\namet\f\any}{}}
\\[1mm]
\tr e{\K,\Env,\Call\e\f{}} =  \src{\DynCall\ep{\name\f\any}{}}  \HS \WHERE \ep = \tr e{\K,\Env,\e}, \TypeCk{\K,\Env}\e\any
\\[1mm]
\tr e{\K,\Env,\Call\e\f{}} =  \src{\Call\ep{\name\f\any}{}}  \HS \WHERE \ep = \tr e{\K,\Env,\e}, \TypeCk{\K,\Env}\e\C
\\[1mm]
\tr e{\Call\this\f\e} =  \src{\Call\this{\name\f\any\any}\ep} \HS \WHERE  \TypeCk\K\this\C, \HS
\ep = \tr a{\K,\Env,\any,\e}
\\[1mm]
\tr e{\Call{\e_1}\f{e_2}} = \src{\DynCall{\eps 1}{\name\f\any\any}{\eps 2}}
\HS \WHERE \ep = \tr e{\K,\Env,\e}, \TypeCk{\K,\Env}\e\any \HS 
\HS\WHERE \eps 1 = \tr a{\K,\Env,\any,\e_1}, \HS
\eps 2 = \tr a{\K,\Env,\any,\e_2}
\\[1mm]
\tr e{\Call{\e1_1}\m{e_2}} = \src{\DynCall{\eps 1}{\name\m\any\any}{\eps 2}} \HS \WHERE  \eps 1 = \tr e{\e_1}, \HS \eps 2 = \tr e{e_2}\\[1mm]
\tr e{\New\C{\e_1..}} =  \src{\New\C{\eps 1..}}\HS \WHERE \eps 1 = \tr e{\e_1}\\[1mm]
\tr a{\K,\Env,\t,\e} = \e
\\[1mm]
\tr a{\K,\Env,\t,\e} = \SubCast\t\e
   \> \WHERE     \> \TypeCk{\K,\Env}\e\tp, \HS (\t = \any \OR \tp = \any), \HS \ep =\tr e{\K,\Env,\e}
\\[1mm]
\tr a{\K,\Env,\t,\e} = \ep\\
   \> \WHERE     \> \TypeCk{\K,\Env}\e\tp, \HS (\t \Sub \tp \OR \consistent\K\t\tp), \HS \ep =\tr e{\K,\Env,\e}
\end{tabbing}
\end{minipage}
\end{tabular}
%\caption{Transient}\end{wrapfigure}
