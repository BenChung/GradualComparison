...
The features that we exploit here are the presence of static type system
equipped with dynamic casts that test the run-time type of values, the
ability to dynamic resolve method targets, and support for generating new
classes at run-time.\footnote{Both the JVM and the CLR have runtime type
