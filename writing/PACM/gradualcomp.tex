...
class classes, through a system of contracts, dynamically enforcing type guarantees. 
Our translation from Typed Racket to \kafka encapsulates the core of Typed Racket's
functionality, highlighting the key issues of type identity that Typed Racket raises.

To illustrate how Typed Racket approaches gradual typing, we leave out several
features that are important for a real programming language, but are not
relevant to  the core of the language, including first class classes and
inheritance. As a result of these changes, our model is very similar to
