...
\\[-2mm]
\SPP \Mdef\m\x{\t}{\tp}{~\Set{\Get\this\that\C}\m{\x}~}
...
&  \Mtype\f\t\t \in \bmt\\
\SPP   \Mdef\m\x\any\any {~\bscast\any{\Call{\Get\this\that\C}\m{\bscast{\t}\x} }~}
&  \Mtype\m\t\t\in\b\mt \\
\\
\SP \}\\
\end{array}\]
...
\e &::=  \x          &\B \this          \\
   &\B \New\C{\b\e}  &\B \sGet\e\f       &\B \Set\e\f\e   \\
   &\B \Call\e\m\e   &\B \a \\ 
\end{tabular}\end{minipage}
\begin{minipage}{5.9cm}\begin{tabular}{l@{~}l@{}l@{}l}
   ~ \k &::= \Class \C {\b\fd}{\b\md}
...
\e &::=  \x         &\B \this    &\B \sGet\e\f      \\
   &\B \Set\e\f\e &\B \Call\e\m\e &\B \DynCall\e\m\e  \\
   &\B \New\C{\b\e}  \\ 
