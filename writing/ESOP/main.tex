...
\figref{fig:travar} presents the translation for the field access expression and the variables. 
...
\begin{figure}
	\begin{tabular}{llc@{\hspace{.25cm}}l@{\HS}l@{\HS}l}
		...
		{\scriptsize Optional} \\
		\TR[\OTS]{\Class\C{\fd[1]..}{\md[1].. }} & =  \src{\Class \C {\fd[1]..}{\mdp[1].. } } & \WHERE & \fdp[1] = \src{\Ftype\f\any}..\HS\HS \fd[1] = \Ftype\f\t .. \\ 
		& & & \md[1] = \Mdef\m\x{\t[1]}{\t[2]}\e \\
        ...
        & & & \ep = \TAG[\CTS]{\e}{\HT\this\C\,\HT\x{\t[1]}}{\t[2]} ..\\
        & & & {\mdp[1]} = \src{\Mdef\m\x{{\t[1]}}{{\t[2]}}{\ep}} .. \\ 
