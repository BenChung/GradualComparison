...
\figref{fig:trassn} presents the translation for the field assignment expression. 
Apart from the optional semantics, the translation for the field assignment expression
is almost identical between the transient, behavioral, and concrete semantics. The 
only difference lies in which semantics to further break down the assigned expression, 
whereby each semantics require their respective judgment. The optional semantics 
require an additional any cast to ease any typing information from the assigned expression.
