...
All programs execute correctly under the optional semantics, as the typing
pathologies are never relied upon dynamically.
...
This translation illustrates optional typing's lack of impact on performance,
one of the features highlighted by Bracha~\cite{pluggabletypes}. A notional
type-less language would have an identical translation, causing performance to
...
compare type tags, as in Java or similar languages), the concrete semantics
provides acceptable performance~\cite{oopsla09}. 

However, this strong guarantee is a result of the rigid semantics of the cast
...
programmer to add a potentially large number of types in order to begin using
...
concrete semantics, requiring typed values to have been statically checked,
