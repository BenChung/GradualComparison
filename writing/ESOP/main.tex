...
We then translate this same source language to \kafka, modeling the semantics
of each of the gradual type systems. Each of the type systems in question
provides a different soundness guarantee, which drives their
translations, and determines what programs are allowed dynamically.
%
%\subsection{Optional}
%
