...
still being debated, it is worthwhile that the notion of what consitutes an
error is still fuzzy.  Each of the approach will catch different errors,


Beyond the difference in runtime
