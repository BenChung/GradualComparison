...
\CondRule{E2}{
     \sp 2 = \Heap{\sp 1}{ {\ap 1}\is\Obj{\b{\Fdef\f\t\a}}\C\C\}}
}{ 
    \ReduceA{ \New\C{\b\a} }{\sp 1}{\ap 1}{\sp 2}
}
\CondRule{E3}{
    \s(\a) = \Obj{\dots}\t\C ~~ \C has \Mdef\m\x{\tp 1}{\tp 2}\e
}{
   \ReduceA{ \Call\a\m{\ap 1}}{\s}{  [\a/\this][{\ap 1}/\x]\e } {\s }
}
\CondRule{E3}{ 
      \s(\a) = \Obj{ \dots\Fdef\f\t{\ap 1}\dots }{\tp 1}{\C}
}{
  \ReduceA{\Get\a\f}{\s}{\ap 1}{\s}
}
\CondRule{E4}{
     \sp 2 = \Heap{\sp 1}{\a\is \Obj{\dots \Fdef\f\t{\ap 1}\dots}\t\C}
}{
...
\begin{tabular}{l@{}l}
\s &::= \empty \\
\Alt{  \Heap\s{\a \is \Obj{\b{\Fdef\f\t\a}}{\tp 1}{\tp 2}} } \\
\F &::=    \Get\square\f \\
   \Alt{    \Set\square\f\e}
   \Alt{    \Set\a\f\square    }
   \Alt{    \Call\square\m\e}
