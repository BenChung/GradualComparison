...
\statictype\t\K, monotone casts will leave the object and the heap
unchanged.
...
The \texttt{typemeet} functions takes four arguments, the original type
...
\IRule{TM3}{ }{\tmeet\any\any\P\K = \any\,\K}
