...
~ \\[2cm]
  {\small
\begin{tabular}{l|lllllllllrr}
&  & \rot{Nominal types}
  & \rot{Class based}
  & \rot{First-class Class}
  & \rot{Soundness claimed}
  & \rot{Unboxed primitives}
  & \rot{Subtype cast}
  & \rot{Shallow cast}
  & \rot{Generative cast}
  & \rot{Reported pathology}\\
  \\\hline
  Typed Racket &&   & x & x & x &   &   & x & x & 121x  &\\\hline
  StrongScript && x & x &   & 1 &   & x &   &   & 1.1x  & \\\hline
  Thorn        && x & x &   & 1 & x & x &   &   & 1x  &\\\hline
  Reticulated
  Python       &&   &  \\
  Monotonic    &&   & x &   & x &   &   &   & x &   &\\
  Transient    &&   & x &   & x &   &   & x &   &   &\\
  Guarded      &&   & x &   & x &   &   &   & x &  10x &\\\hline
  Gradualtalk  && x & x &   & x &   &   &   & x &  5x &\\\hline
  C\#          && x & x &   & x & x & x &   &   &  - & \\\hline
  Dart         && x & x &   &   &   & x &   &   &  - &\\\hline
  Hack         && x & x &   &   &   & x &   &   &  - & \\\hline
\end{tabular}}
