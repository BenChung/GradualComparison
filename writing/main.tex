...
The \texttt{typemeet} functions takes four arguments, an environment $\P$, a class table $\K$, the original type $\t$, the cast type $\tp$, 
...
The \texttt{methmeet} functions takes four arguments, the environment $\P$, a class table $\K$, the original method types $\b\mt$, the cast method types $\b\mtp$, 
and outputs method types $\b\mtpp$ and a class table $\Kp$.
