...
\begin{mathpar}
\IRule{WC}{
 \xt{overloading}_{\emptyset}(\b\fd,\b\md)\OK \\
...
\opdef{~\xt{overloading}(\b\md)}{Method overloading}
\begin{mathpar}
\IRule{MO1}{
}{
...
\xt{overloading}_{\cmd}(\Mdef\m\x\t\t\e, \b\md)
}
...
\xt{overloading}_{\cmd}(\Mdef\f\x\t\t\e, \b\md)
}
...
\xt{overloading}_{\cmd}(\Mdefz\f\t\e, \b\md)
}
\end{mathpar}
