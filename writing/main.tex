...
\IRule{M8}{
   ...
   \meet\P\Kpp{\b{\mt_1}}{\b{\mt_2}} = \b{\mt_3}~\K'''
    ...
    \meet\P\K{\Mtype\f{{\t_1}}{\t_2}~\b{\mt_1}}{\Mtype\f{{\t_3}}{\t_4}~\b{\mt_2}} = \Mtype\f{\t_5}{\t_6}~\b{\mt_3}~\K'''
}

\IRule{M9}{
      \meet\P\K{\t_2}{\t_4} = {\t_6}~\Kp \\
      \meet\P\Kp{\b{\mt_1}}{\b{\mt_2}} = \b{\mt_3}~\Kpp
}{
    \meet\P\K{\Mtype\f{}{\t_2}~\b{\mt_1}}{\Mtype\f{}{\t_4}~\b{\mt_2}} = \Mtype\f{}{\t_6}~\b{\mt_3}~\Kpp
}
\end{mathpar}
