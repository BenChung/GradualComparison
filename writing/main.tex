...
exceptions.\footnote{ Precise exception have a price, they inhibit some
  compiler optimizations, but supporting stack traces only requires the
  compiler to retain names of methods on the stack and collect them when an
  exception is thrown.} It is likely that recording blame may be more costly
as some information must be associated with every value at every cast.
...
\hrulefill
\begin{mathpar}
\IRule{REW1}{ }{ \rtranst{\b{\mt}}{\b{\mtp}}\e\x\e\x }
\\
...
\IRule[width=20em]{REW4}{ \e_1 \neq \this \\ \rtranst{\b{\mt}}{\b{\mtp}}\e\x{\e_1}{\e_2} \\ \b{\rtranst{\b{\mt}}{\b{\mtp}}\e\x{\ep_1}{\ep_2}}}{\rtranst{\b{\mt}}{\b{\mtp}}\e\x{\Call{\e_1}\n{\b{\ep_1}}}{\Call{\e_2}\n{\b{\ep_2}}}}

\IRule{REW5}{ \rtranst{\b{\mt}}{\b{\mtp}}\e\x{\e_1}{\e_2} \\ \rtranst{\b{\mt}}{\b{\mtp}}\e\x{\ep_1}{\ep_2}}{\rtranst{\b{\mt}}{\b{\mtp}}\e\x{\DynCall{\e_1}\m{\ep_1}}{\DynCall{\e_2}\m{\ep_2}}}

\IRule{REW6}{ \rtranst{\b{\mt}}{\b{\mtp}}\e\x{\b\e}{\b\ep} }{\rtranst{\b\mt}{\b\mtp}\e\x{\New\C{\b\e}}{\New\C{\b\ep}}}
\end{mathpar}
...
&&&&\wedge&\rtranst{\bmt}\bmtp{(\BehCast\any\x)}\x\e\x{\e}{\ep}
\\
