...
<<<<<<< HEAD
  \htype\a\S{\sigma[\a \mapsto \C\{\b\ap\}]}\K = \D~\Kp
=======
  \htype\a\S{\sigma[\a \mapsto \C\{\ap\}]}\K = \C~\Kp
>>>>>>> 68a545bf150518e6107a2dbba625e0904681ec43
}
...
\IRule{ENT1}{ 
  ...
  \Kp = \K\,\D \\
  \Wp = \W\,\Bind\C\D \\
  \Class\D{\hspace{-0.3em}}{\Fdef\that\Cp ~ \enformt{\b{\md}}{\Wp}{\Kp} } \\ 
}{
...
\IRule{ENMT1}{
  ...
  \enformt{\b\md}{\Wpp}{\Kpp} = \b\mdpp \\
}{
  \enformt{\md\,\b\md}{\W}{\K} = \mdpp\,\b\mdpp
}
