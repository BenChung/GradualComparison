...
&    \All f \Mtype\f{}\t\in\mt &\wedge~ \Mtype\f{}\tp \in \mtp
\\
\SPP \Mdef\f\x\tp\tp {~\Call{(\BehCast\tp{\this.\that})}\f{\BehCast\t\x}~}
&    \All f \Mtype\f\t\t \in \mt &\wedge~ \Mtype\f\tp\tp \in \mtp
\\
\SPP \Mdef\m\x{\t_2}{\tp_2} {~\Call{(\BehCast{\tp_2}{\this.\that})}\m{\BehCast\Cp\x}~}
&     \All m \Mtype\m\Cp\Cpp\in\mt &\wedge~ \Mtype\m{\t_2}{\tp_2} \in\mtp
\\
\SPP \Mdef\m\x{\t_2}{\tp_2} {~\DynCall{(\SubCast{\any}{\this.\that})}\m{\BehCast\any\x}~}
&     \All m \Mtype\m{\any}{\any} \in \mt &\wedge~ \Mtype\m{\t_2}{\tp_2} \in \mtp
\\
\SPP \Mdefz\f\t { ~\Call{\this.\that}\f{}~}
&    \All f \Mtype\f{}\t \in \mt &\wedge~ \Mtype\f{}\tp \not\in \mtp
\\
\SPP \Mdef\f\x\t\t { ~\Call{\this.\that}\f\x~}
&    \All f \Mtype\f\t\t \in \mt&\wedge~ \Mtype\f\tp\tp \not\in \mtp
\\
\SPP \Mdef\m\x{\Cp}{\Cpp} {~\Call{\this.\that}\m\x~}
&    \All m \Mtype\m{\Cp}{\Cpp} \in \mt &\wedge~ \Mtype\m{\t_2}{\tp_2} \not\in \mtp
\\
\SPP \Mdef\m\x\any\any {~\Call{(\SubCast\any{\this.\that})}\m\x~}
&    \All m \Mtype\m\any\any\in\mt &\wedge~ \Mtype\m\t\tp\not\in\mtp
\\
\SP \}
\\
\wrap\C\mt\D = \\
