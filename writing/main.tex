...
solely to catch errors at \textcolor{red}{checking time}, they should never affect the
...
\item{\bf L4:} Fails in Monotonic because the object refered to by \code x
  in method \ss is cast to \code I. This updates the effective type of field
