...
\IRule[width=18em]{WT}{
 ...
 \WF \Env\s\K {\Mdef\mdt\x\C\D\e}
}

\IRule[width=18em]{WU}{
 \EnvType {\Env~\Ftype\x\any~}\s\K \e\any\\
}{
 \WF \Env\s\K{\Mdef\mdu\x\any\any\e}
}
...
\IRule[width=20em]{W6}{
  \EnvType \Env\s\K\e\C \\
  \Mtype \mdt\Cp\Cpp\in \classoff\C\K  \\
  \EnvType \Env\s\K\ep\C
}{
  \EnvType \Env\s\K{\Call\e\mdt\ep}\Cpp
}    

\IRule[width=20em]{W7}{
  \EnvType \Env\s\K\e\C \\
  \Mtype \mdu\any\any\in \classoff\C\K  \\
  \EnvType \Env\s\K\ep\any
}{
  \EnvType \Env\s\K{\Call\e\mdu\ep}\any
}    
...
\IRule{W8}{
  ...
  \EnvType \Env\s\K{\DynCall\e\mdu\ep}\any
}    
...
\IRule{MT}{
  ...
  \methtrans {\K}{\C}{\Mdef\m\x{\t}{\tp}{\e}}{\Mdef\mdu\x\any\any\ep}{}
}
\end{mathpar}
...
\IRule{THS3}{
    ...
    \GenCast\K\Env{\Call{\e_1}\m{{\e_2}}}{\SubCast\D{\DynCall{\e_3}\mdu{\SubCast\any{\e_4}}}}{\D_2} %Q: do I need to cast the return value of non-bang
}
...
\IRule{THS4}{
    ...
    \GenCast\K\Env{\Call{\e_1}\m{{\e_2}}}{\DynCall{\e_3}\mdu{{\e_4}}}{\t}
    %Q: do I need to cast the return value of non-bang
}
...
\IRule{THS5}{
  ...
  \GenCast\K\Env{\Call{\e_1}\m{\e_2}}{\Call{\e_3}\mdt{\e_4}}{\tp}
}
...
\IRule{MTU}{
  \AnaCast{\K}{\HT\this\C~\HT\x\any}{\e}{\ep}{\any}
}{\methtrans\K\C{\Mdef\m\x\any\any\e}{\Mdef\mdu\x\any\any\ep}{}}

\IRule{MTT}{
  \t \neq \any \\
  \AnaCast{\K}{\HT\this\C~\HT\x\t}{\e}{\ep}{\tp}
}{\methtrans\K\C{\Mdef\m\x\C\Cp\e}{\Mdef\mdu\x\any\any{\SubCast{\any}{\New{\EMxt{A2}}{\ShaCast\C\x, \e}.{\EMxt{f2}}()}}}{}}
\end{mathpar}
...
\IRule[width=30em]{GRS2}{
    ...
    \GenCast\K\Env{\Call{\e_1}\m{{\e_2}}}{\ShaCast{\t_2}{\Call{{\e_3}}\mdu{\SubCast{\any}{\e_4}}}}{\t_2}
}
...
\IRule{MTT}{
  ...
  \methtrans {\K}{\C}{\Mdef\m\x{\C}{\Cp}{\e}}{\Mdef\mdt\x\C\Cp\ep}{}
}
...
\opdef{$\GenCast{\K}\Env\e\ep\t$}{Type Racket translation for expressions}
...
\IRule[width=30em]{TRS3}{
    ...
    \GenCast\K\Env{\Call{\e_1}\m{{\e_2}}}{\Call{\e_3}\mdt{{\e_4}}}{\Cpp}
}

\IRule[width=20em]{TRS4}{
    \GenCast\K\Env{\e_1}{\e_3}{\C} \\ \m({\any}):\any \in \classoff\C\K \\ \b{\AnaCast\K\Env{\e_2}{\e_4}{\any}}
}{
    \GenCast\K\Env{\Call{\e_1}\m{{\e_2}}}{\Call{\e_3}\mdu{{\e_4}}}{\any}
}
...
\IRule{MTT}{
  \AnaCastMono \K{\HT\this\C~\HT\x\t}\e\ep\tp{\K_1} \\
  \monowrap{\C_1}\K = \t_2~\K_2 \\
  \monowrap{\Cp_1}\K = \tp_2~\K_3
}{
  \methtrans \K\C{\Mdef\m\x{\C_1}{\Cp_1}\e}{\Mdef\mdt\x{\t_2}{\tp[2]}\ep}{\K_1~\K_2~\K_3}
}

\IRule{MTU}{
  \AnaCastMono \K{\HT\this\C~\HT\x\any}\e\ep\any{\K_1} \\
}{
  \methtrans \K\C{\Mdef\m\x{\any}{\any}\e}{\Mdef\mdu\x{\any}{\any}\ep}{\K_1~\K_2~\K_3}
}
\end{mathpar}
...
\IRule[width=30em]{MOS3}{
    ...
    \GenCastMono\K\Env{\Call{\e_1}\m{{\e_2}}}{\Call{\e_3}\mdt{{\e_4}}}{\t_2}{\K_1~\b{\K_2}}
}

\IRule[width=30em]{MOS3}{
    \GenCastMono\K\Env{\e_1}{\e_3}{\C}{\K_1} \\ \m({\t_1}):\t_2 \in \classoff\C\K \\ \lnot\statictype{\t_1}{\K}{\cdot} \\ \b{\AnaCastMono\K\Env{\e_2}{\e_4}{\t_1}{\K_2}}
}{
    \GenCastMono\K\Env{\Call{\e_1}\m{{\e_2}}}{\DynCall{(\MonCast\any\e_3)}\mdu{\MonCast\any{\e_4}}}{\t_2}{\K_1~\b{\K_2}}
}

\IRule{MOS4}{
    \GenCastMono\K\Env{\e_1}{\e_3}{\any}{\K_1} \\ {\AnaCastMono\K\Env{\e_2}{\e_4}{\any}{\K_2}}
}{
    \GenCastMono\K\Env{\Call{\e_1}\m{{\e_2}}}{\DynCall{\e_3}\mdu{{\e_4}}}{\any}{\K_1~\K_2}
}
