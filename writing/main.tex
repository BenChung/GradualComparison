...
type, and are denoted \Obj{\b{\Fdef\f\t\a}}{\b{\Mdef\m\x\t\t\e}}{\t}. 
...
\CondRule{E2}{
     \sp 2 = \Heap{\sp 1}{ {\ap 1}\is\Obj{\b{\Fdef\f\t\a}}{\it methods(\C)}\C\}}
}{ 
...
\CondRule{E3}{ 
      \s(\a) = \{\dots\Fdef\f\t{\ap 1}\dots\B \t\}
}{
  \ReduceA{\Get\a\f}{\s}{\ap 1}{\s}
}
\CondRule{E4}{
     \sp 2 = \Heap{\sp 1}{\a\is \{\dots \Fdef\f\t{\ap 1}\dots\B \t\}}
}{
