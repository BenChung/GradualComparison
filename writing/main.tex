...
\newcommand{\bind}[3]{\M{\xt{bind}(#1, #2, #3)}}
\[ 
\bind{\sp1}{\ap1}{\Obj{\b{\ap2}}\t\C} \equiv \Heap{\sp1}{\Bind{\ap1}{\Obj{\b{\ap2}}\t\C}}
\]

\newcommand{\dispatch}[4]{\M{\xt{dispatch}(#1,#2,#3,#4)}}

\[
  \dispatch\s{\a}\m{\b\x} \equiv \e \text{ if }  \Mdef\m\x{\tp 1}{\tp 2}\e\inc \classof{\Sel\s\a}
\]
