...
\IRule{RC1}{
  ...
  \tmeet\tp\t\cdot\K = \tpp\,\Kp\\ 
  \tp\not\EQ\tpp \\
  \b{\a~\t} = \fieldtypes \a\s\Kp \\
  \Sp = \Map\S{\Bind\a\tpp} \\
  \retype{\b\a}{\b\t}\Sp\s\K = \Spp\,\Kpp
}{
...
The function \fieldtypes\a\s\K return the values of the fields of \a and their types.
