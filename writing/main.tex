...
implementation strategies seems daunting.\footnote{Most practical
  ...
  They are neither comparable between each other, nor worst case performance
  indicators as most languages have not been used enough to have rigorous
  evaluations.  }  Predictably, industrial strength systems have chosen to
compromise on soundness to avoid degrading performance.\footnote{Languages
  such as Dart, Typescript, Hack all have unchecked, or partially checked,
  execution modes that will not catch all type errors.}
...
influenced existing systems and discuss the implication of design decisions.
Hopefully we can lay out some research questions that future research in the
field can address. In order to present the essence of gradual typing for
objects we introduce \kafka, a statically typed class-based calculus with
mutable state and structural subtyping. Untyped method calls are supported
with a distinct dynamic dispatch operation. The calculus allows for class
generation, in particular, it allows the generation of transparent wrapper
classes. We define the semantics of various gradual type systems by
translation from a surface syntax into \kafka extended with generative
casts.
...
\newcommand{\rtranst}[3]{#1 \vdash #2 \looparrowright_t #3}
\begin{mathpar}
\IRule{REW1}{ }{ \rtranst{\b\mt}\x\x }

\IRule{REW2}{ }{\rtranst{\b\mt}{\Get\this\f}{\SubCast\any{\Get\this\f}} }

\IRule{REW3}{ \e \neq \this \\ \rtranst{\b\mt}{\e}{\ep} }{\rtranst{\b\mt}{\Get\e\f}{\Get\ep\f}}

\IRule{REW4}{ \Mtype\f\t\t \in \b\mt }{\rtranst{\b\mt}{\Set\this\f\e}{\SubCast\any{\Set\this\f{\BehCast\t\e}}}}

\IRule{REW5}{ \e_1 \neq \this \\ \rtranst{\b\mt}{\e_1}{\e_2} \\ \rtranst{\b\mt}{\ep_1}{\ep_2} }{\rtranst{\b\mt}{\Set{\e_1}\f{\ep_1}}{\Set{\e_2}\f{\ep_2}}}

\IRule{REW6}{ \rtranst{\b\mt}{\e_1}{\e_2} \\ \rtranst{\b\mt}{\ep_1}{\ep_2}}{\rtranst{\b\mt}{\DynCall{\e_1}\m{\ep_1}}{\DynCall{\e_2}\m{\ep_2}}}

\IRule{REW7}{ \rtranst{\b\mt}{\b\e}{\b\ep} }{\rtranst{\b\mt}{\New\C{\b\e}}{\New\C{\b\ep}}}
\end{mathpar}
