...
\newcommand{\rtranstz}[6]{#1 \Rightarrow #2 ~ #3 / #4 \vdash #5 \looparrowright_{mon} #6}

\begin{figure}[!ht]
\hrulefill
\begin{mathpar}
\IRule{MREW1}{ }{ \rtranstz{\b{\mt}}{\b{\mtp}}\e\x\x{[\e/\x]\x} }
\\
\IRule[width=25em]{MREW2}{ \Mtype\n{\b{\t_1}}{\tp_1} \in \b{\mt} \\ \Mtype\n{\b{\t_2}}{\tp_2} \in \b{\mtp} \\ \n = \f \vee \t_1 \neq \any  \\ 
\b{\rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\e}{\ep}}}{\rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\Call{\this}\n{\b\e}}{\MonCast{\tp_1}{\Call{\this}\n{\b{\MonCast{\t_2}{\ep}}}}}}
\\

\IRule[width=20em]{MREW3}{ \e_1 \neq \this \\ \rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\e_1}{\e_2} \\ \b{\rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\ep_1}{\ep_2}}}{\rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\Call{\e_1}\n{\b{\ep_1}}}{\Call{\e_2}\n{\b{\ep_2}}}}

\IRule{MREW4}{ \rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\e_1}{\e_2} \\ \rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\ep_1}{\ep_2}}{\rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\DynCall{\e_1}\m{\ep_1}}{\DynCall{\e_2}\m{\ep_2}}}

\IRule{MREW5}{ \b{\rtranstz{\b{\mt}}{\b{\mtp}}\e\x{\e}{\ep}} }{\rtranstz{\b\mt}{\b\mtp}\e\x{\New\C{\b\e}}{\New\C{\b\ep}}}
\end{mathpar}
...
&
 \All f \Mtype\f{}\t \in \bmt &\wedge& \Mtype\f{}\tp \in \bmtp
\\[1mm]\hline
\SPP \Mdef\m\x\any\any {~\SubCast\any{\MonCast\tp{{\ep}}}~}
...
\begin{mathpar}
\IRule{PT}{
  {\classtrans{\src\K}{\src\K}{\K'}} \\ \GenCast{\src\K}{\cdot}{\src\e}{\ep}{\src\t} 
}{\progtrans{\src\e~\src\K}{\e'~{\K'}}}

\IRule{CR1}{ 
  \b{\methtrans {\src\K}{\src\C}{\src\md}{\md'}{}} \\
  \classtrans {\src\K}{\src\Kp}\Kpp
}{
   \classtrans {\src\K}{\src{\Class \C{\b{\Ftype\f\t}}{\b\md}~\Kp}}{\Class \C {\b{\Ftype\f\t}}{\b{\md'}}~\Kpp}}

\IRule{CR2}{ 
}{
  \classtrans {\src\K}\cdot\cdot
}

\IRule{MT}{
  \AnaCast {\src\K}{\HT\this{\src\C}~\HT\x{\src\t}}{\src\e}\ep{\src\tp}
}{
  \methtrans {\src\K}{\src\C}{\Mdef\m\x{\src\t}{\src\tp}{\src\e}}{\Mdef\m\x\t\tp\ep}{}
}
\end{mathpar}
...
\begin{mathpar}
\IRule{A1}{\HasType{\Env}\x\t}{\GenCast{\K}\Env\x\x\t}
