...
implementation strategies seems daunting.\footnote{Most practical
  ...
  existence of configurations of type annotations that hurt performance.
  They are neither comparable between each other, nor worst case indicators.
  Most systems lack rigorous evaluations.  } Predictably, industrial
strength systems have chosen to compromise on soundness to avoid degrading
performance.\footnote{Industrial languages such as Dart, Typescript, Hack
  have unchecked, or partially checked, execution modes that will not catch
  all type errors.}
...
discuss the practical implications of different choices in the light of our
experience with the implementation of several gradually typed systems.
