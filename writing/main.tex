...
\begin{mathpar}
\IRule[width=18em]{WFM}{
 \EnvType {\Env{~\Ftype\x\t'}~}\s\K\e\t\\
 \WFtype\K\t \\
 \WFtype\K\t' \\
}{
 \WF \Env\s\K {\Mdef\m\x\tp\t\e}
}
...
% \opdef{~\WF{}\cdot\K\k}{Well-formed class table}
% \begin{mathpar}
% \IRule{WH}{
%  \WFtype\K{\b{\fd}}\\
%  \WF\cdot\s\K{\b\md}
% }{
%  \WF{}\cdot\K{\Class\C{\b{\fd}}{\b\md}}
% }
% \end{mathpar}
...
% 
% The judgement \xt{dynamic}(\t,\,\K) denotes every method in type \t contains only \any. 
% 
% \begin{mathpar}
% \IRule{DF1}{
%  }{
...
% 
% \IRule{DF1}{
%  \Class\C {\b\fd}{\Mdef{\m_{1}}{\x_{1}}{\any}{\any}{\dots} \dots ~\Mdef{\m_{n}}{\x_{n}}{\any}{\any}{\dots}}\in\K
%  }{
%  \xt{dynamic}(\C,\,\K) 
% }
% \end{mathpar}
...
\IRule[width=30em]{TSS2}{
    ...
    \GenCast\K\Env{\Call{\e_1}\m{\b{\e_2}}}{\DynCall{\e_3}\mdu{\b{\e_4}}}{\t_2}
}
...
\opdef{$\GenCast{\K}\Env\e\ep\t$}{Typed Racket translation for expressions}
...
\opdef{$\AnaCast\K\Env\e\ep\t$}{Type Racket translation for bidirectional expressions}
...
If $\WFp \K$ (TODO), if $\C \in \K$, $\Cp \in \K$, $\D$ free, $\b\md = \getmds\C\K$, $\bmt = \classoff\C\K$, $\bmtp = \classoff\Cp\K$, and $\k = \wrapAny\C{\b\md}\bmt\D$, then $\StrSub\cdot{\K~\k}\D\Cp$ and $\WFp \k$.
