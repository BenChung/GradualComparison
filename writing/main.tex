...
Fails in Transient, TR, Thorn, Mono
Succ: in Dart
...
Fails in Thorn
Succ: in Tran, Mon, TR, Dart
----------------------------------

class A
   f: *
   m(a : A):A {this.f(new C()} 
...
\hrulefill
\begin{mathpar}
\IRule{REW1}{ }{ \rtranst{\b{\mt}}{\b{\mtp}}\e\x\x{\x[\e/\x]} }
\\
...
\IRule{REW6}{ \b{\rtranst{\b{\mt}}{\b{\mtp}}\e\x{\e}{\ep}} }{\rtranst{\b\mt}{\b\mtp}\e\x{\New\C{\b\e}}{\New\C{\b\ep}}}
\end{mathpar}
