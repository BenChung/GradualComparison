...
Class translation also provides another key component, insertion of guard methods. To ensure type safety
for untyped call sites, we have to dynamically type check the argument. The guard methods, denoted 
$\m_\xt{u}$, perform these checks in a call to the real underlying method, and are used in the cast insertion
process.
