...
4.0~\cite{Beirman10}, Thorn~\cite{oopsla09},
...
~ \\[2cm]
  {\small
\begin{tabular}{l|llllllllllllllr}
& & \rot{Nominal}
  & \rot{Optional types}
  & \rot{Concrete types}
  & \rot{Promised types}
...
Dart        &&x &x &  &  & x &   &   &   & x &   &   &   &  - &\\\hline
Hack        &&x &x &  &  & x &   &   &   & x &   &   &   &  - & \\\hline
C\#         &&x &x &x &  & x &   & x & x & x &   &   &   &  - & \\\hline
Thorn       &&x &x &x &  & x &   & 1 & x & x &   &   &   & 1x  &\\\hline
StrongScript&&x &x &x &x & x &   & 1 &   & x &   &   &   & 1.1x  & \\\hline
Typed Racket&&  &  &  &x & x & x & x &   &   & x & x & x & 121x  &\\\hline
Gradualtalk &&x &  &  &x & x &   & x &   &   &   & x & x &  5x &\\\hline
Reticulated
Python      &&  &  \\
\it Monotonic&&  &  &  &x & x &   & x &   &   &   & x & x &   &\\
\it Transient&&  &x &  &  & x &   & x &   &   & x &   & x &   &\\
\it Guarded  &&  &  &  &x & x &   & x &   &   &   & x & x &  10x &\\\hline
\end{tabular}}
\caption{Overview of implemented systems.}\label{over}
\end{figure}

REWRITEREWRITEREWRITEREWRITEREWRITEREWRITEREWRITEREWRITE
