...
\inferrule*[lab=TSApp]{\GSdash e_r : \any \\ \bar{\GSdash e : \tau'}}{\GSdash (\scast{\m}e_r).\m(\bar{e}) : \any}
...
\inferrule*[lab=EMethCast]{v = a \wedge \s[a \is \{\ldots | \C\}] \wedge \m \in meths(\C)}{ \{\m\}v,\s \ereduce v,\s}

\inferrule*[lab=EMethCastError]{ }{ \{\m\}v,\s \ereduce \error,\s}
\end{mathpar}
