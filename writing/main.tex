...
Since we don't have inheritance, I think we don't need transitivity. The SRec rule does everythign we need.
...
\IRule{SMet}{
  ...
  \BasicType\MN {\t \Sub \t_2} \\
  \BasicType\MN {\t_2' \Sub \tp}  
}{
 \BasicType \MN {\C\Sub\Mdef\m\x\t\tp\e}
}
...
\IRule{SRec}{
 ...
 \M' = \M~\C\Sub\D\\
 \fd\in\b\fd \implies \BasicType{\M'~\K}{\C\Sub\fd}\\
 \md\in\b\md \implies \BasicType{\M'~\K}{\C\Sub\md}\\
}{
 \BasicType \MN {\C} \Sub \D 
}
\end{mathpar}
