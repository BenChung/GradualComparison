...
\begin{figure}
\opdef{$e,\s \ereduce r,\s'$}{$e$ with heap $\s$ evaluates to $r$ and $\s$ in one step}
\begin{mathpar}
\EFrame

\inferrule*[lab=EFrameCastError]{ e,\s \ereduce \casterror,\s'}{F[e],\s \ereduce \casterror,\s'}
...
\inferrule*[lab=ECastError]{ }{\cast{\t}v,\s \ereduce \casterror,\s}
\end{mathpar}
