...
\caption{Behavioral cast wrapper class generation.}\label{wrap}
\end{figure}
...
\SP \class ~\D ~ \{\\
\SPP \Fdef\that\C \\
\SPP \Mdefz\f{\tp}{~\BehCast\tp{\Call{\Call\this\that{}}\f{}}~}
&    \All f \Mtype\f{}\t\in\bmt &\wedge& \Mtype\f{}\tp \in \bmtp
\\
\SPP \Mdef\f\x\tp\tp {~\BehCast\tp{\Call{\Call\this\that{}}\f{\BehCast\t\x}}~}
&    \All f \Mtype\f\t\t \in \bmt &\wedge& \Mtype\f\tp\tp \in \bmtp
\\
\SPP \Mdef\m\x\t\tp {~\BehCast\tp{\Call{\Call\this\that{}}\m{\BehCast\Cp\x}}~}
&     \All m \Mtype\m\Cp\Cpp\in\bmt &\wedge& \Mtype\m\t\tp\in\bmtp
\\
\SPP \Mdef\m\x\t\tp{~\DynCall{(\BehCast\any{\Call\this\that{}})}\m{\BehCast\any\x}~}
&     \All m \Mtype\m\any\any\in\bmt &\wedge& \Mtype\m\t\tp\in\bmtp
\\
\SPP \Mdefz\f\t { ~\Call{\Call\this\that{}}\f{}~}
&    \All f \Mtype\f{}\t \in \bmt &\wedge& \Mtype\f{}\tp \not\in \bmtp
\\
\SPP \Mdef\f\x\t\t { ~\Call{\Call\this\that{}}\f\x~}
&    \All f \Mtype\f\t\t \in \bmt&\wedge& \Mtype\f\tp\tp \not\in \bmtp
\\
\SPP \Mdef\m\x{\Cp}{\Cpp} {~\Call{\Call\this\that{}}\m\x~}
&    \All m \Mtype\m{\Cp}{\Cpp} \in \bmt &\wedge& \Mtype\m\t\tp\not\in \bmtp
\\
\SPP \Mdef\m\x\any\any {~\DynCall{(\BehCast\any{\Call\this\that{}})}\m\x~}
...
\SP \class~\D~\{\\
\SPP \Fdef \that \C\\ 
\SPP   \Mdefz\f\any{\BehCast\any{\Call{{\Call\this\that{}}}\f{}}}
&  \All \m  \Mtype\f{}\t \in \bmt\\
\SPP   \Mdef\f\x\any\any{\BehCast\any{\Call{\Call\this\that{}}\f{\BehCast\t\x}}}
&  \All \f  \Mtype\m\t\t \in \bmt\\
\SPP   \Mdef\m\x\any\any{\BehCast\any{\Call{\Call\this\that{}}\m{\BehCast\Cp\x}}}
&  \All \m  \Mtype\m\Cp\Cpp \in \bmt\\
\SPP   \Mdef\m\x\any\any{\DynCall{(\BehCast\any{\Call\this\that{}})}\m{\BehCast\Cp\x}}
...
\>\>$\that : \C$ \\
\\
\>\>$\Mdefa\m{{\HT\x\any}}\any { \MonCast\any{\MonCast{\tp_2}{\Call{\Get{\this}{\that}}\m{{\MonCast{\t_1}{\MonCast{\t_2}\x}}}}}}$\\
\>\>\>$\tfa \Mtype\m{{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\m{{\t_2}}{\tp_2} \in \b\mt \wedge \t_1 \neq \any$\\
\\
\>\>$\Mdefa\m{{\HT\x\any}}\any { \MonCast\any{\MonCast{\tp_2}{(\MonCast{\any}{\Get\this\that})@\m({\MonCast{\t_1}{\MonCast{\t_2}\x}})}}}$\\
\>\>\>$\tfa \Mtype\m{{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\m{{\t_2}}{\tp_2} \in \b\mt \wedge \t_1 = \any$\\
\\
\>\>$\Mdefa\f{{\HT\x\any}}\any {\MonCast\any{\MonCast{\tp_2}{\Set{\Get{\this}{\that}}\f{{\MonCast{\t_1}{\MonCast{\t_2}\x}}}}}}$\\
\>\>\>$\tfa \Mtype\f{{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\f{{\t_2}}{\tp_2} \in \b\mt$\\
\\
\>\>$\Mdefa\f{}\any {\MonCast{\any}{\MonCast{\tp_2}{\Get{\Get{\this}{\that}}\f}}}$\\
\>\>\>$\tfa \Mtype\f{}{\tp_1} \in \classoff\C\K \wedge \Mtype\f{}{\tp_2} \in \b\mt$\\
\\
\>\>$\Mdefa\n{\b{\HT\x\any}}\any { {\Call{\Get{\this}{\that}}\n{\b{\MonCast\any{\MonCast{\t_1}\x}}}}}$\\
\>\>\>$\tfa \Mtype\n{\b{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\n{\b{\t_2}}{\tp_2} \not\in \b\mt \wedge (\n = \f \vee \t_1 \neq \any)$\\
\\
\>\>$\Mdefa\m{\b{\HT\x\any}}\any { {(\MonCast{\any}{\Get\this\that})@\m(\b{\MonCast\any{\MonCast{\t_1}\x}})}}$\\
\>\>\>$\tfa \Mtype\m{\b{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\m{\b{\t_2}}{\tp_2} \not\in \b\mt \wedge \t_1 = \any$\\
\\
\>\>$\Mdefa\m{{\HT\x{\t_2}}}{\tp_2} { \MonCast{\tp_2}{\Call{\Get{\this}{\that}}\m{{\MonCast{\t_1}\x}}}}$\\
\>\>\>$\tfa \Mtype\m{{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\m{{\t_2}}{\tp_2} \in \b{\mt} ~$\=$\wedge~ \statictype{\t_2}\K\cdot $\\
\>\>\>\>$\wedge~ \statictype{\tp_2}\K\cdot$
\\
\>\>$\Mdefa\m{{\HT\x{\t_1}}}{\tp_1} { {\Call{\Get{\this}{\that}}\m\x}}$\\
