...
some unusual features to accomodate the translations of various gradual type
...
explicit and implicit fields behave  identically, which has the concequence that
...
The auxiliary function \names{} returns the names of methods, and the auxiliary
...
described techincally does produce terms that typecheck in \kafka, as it erases
...
Because of this type erasure, this translation from TypeScript to \kafka is quite
...
\end{mathpar}
\caption{Monotonic translation for programs, classes, and methods}
\label{fig:mono-trans1}
\end{figure}

The translation from the monotonic surface language to \kafka begins 
in figure \ref{fig:mono-trans2}. The rule \RuleRef{PT} translates 
monotonic programs, \RuleRef{CR1} and \RuleRef{CR2} translates monotonic class,
and \RuleRef{MT} translates monontonic methods. In the \RuleRef{MT} 
