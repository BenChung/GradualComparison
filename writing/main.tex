...
\newcommand{\getmt}[2]{\xt{getMt}(#1,#2)} % getMt(md,K)
\begin{mathpar}
...
\IRule{GMT}{ }{\getmt{\Mdef\m\x{\C}{\Cp}\e}{\K} = \Mtype\m\C\Cp}

\IRule{GFST}{ }{\getmt{\Mdef\f\x\any\any{\SubCast\any{\MonCast\t{
      \Set{\Get\this\that}\f{\MonCast\tp{\MonCast\t\x}}}}}}{\K} = \Mtype\f\t\t}

\IRule{GFGT}{ }{\getmt{\Mdefz\f\any{\SubCast\any{\MonCast\t{\Get{\Get\this\that}\f}}}}{\K} = \Mtype\f{}\t}
\end{mathpar}
