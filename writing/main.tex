...
implementation strategies seems daunting.\footnote{Most practical
  ...
  121x for Typed Racket~\cite{popl16}.}  Predictably, industrial strength
systems have chosen to compromise on soundness to avoid degrading
performance.\footnote{Languages such as Dart, Typescript, Hack all have
  unchecked, or partially checked, execution modes that will not catch all
  type errors.}
