...
\SP \class ~\D ~ \{\\
\SPP \Fdef\that\C \\
\SPP \Mdefz\f\tp{~\BehCast\tp{\this.\Call\that\f{}}~}
&    \All f \Mtype\f{}\t\in{\b\mt} &\wedge~ \Mtype\f{}\tp \in \mtp
\\
\SPP \Mdef\f\x\tp\tp {~\BehCast\tp{\this.\Call\that\f{\BehCast\t\x}}~}
&    \All f \Mtype\f\t\t \in {\b\mt} &\wedge~ \Mtype\f\tp\tp \in \mtp
\\
\SPP \Mdef\m\x{\t_2}{\tp_2} {~\BehCast{\tp_2}{\this.\Call\that\m{\BehCast{\t_1}\x}}~}
&     \All m \Mtype\m{\t_1}{\tp_1} \in {\b\mt} &\wedge~ \Mtype\m{\t_2}{\tp_2} \in \mtp
\\
\SPP \Mdefz\f\t { ~\this.\Call\that\f{}~}
&    \All f \Mtype\f{}\t \in {\b\mt} &\wedge~ \Mtype\f{}\tp \not\in \mtp
\\
\SPP \Mdef\f\x\t\t { ~\this.\Call\that\f\x~}
&    \All f \Mtype\f\t\t \in {\b\mt} &\wedge~ \Mtype\f\tp\tp \not\in \mtp
\\
\SPP \Mdef\m\x{\t_1}{\tp_1} {~\this.\Call\that\m\x~}
&    \All m \Mtype\m{\t_1}{\tp_1} \in {\b\mt} &\wedge~ \Mtype\m{\t_2}{\tp_2} \not\in \mtp
\\
\SP \}
\\
\wrap\C\mt\D = \\
