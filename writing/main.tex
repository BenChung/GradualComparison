...
\>\>\>$\tfa \Mtype\m{{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\m{{\t_2}}{\tp_2} \in \b{\mt} \wedge \statictype{\t_2}\K \wedge \statictype{\tp_2}\K$\\
\\
\>\>$\Mdefa\m{{\HT\x{\t_1}}}{\tp_1} { {\this.\that.\m({{\x}})}}$\\
\>\>\>$\tfa \Mtype\m{{\t_1}}{\tp_1} \in \classoff\C\K \wedge \Mtype\m{{\t_2}}{\tp_2} \not\in \b{\mt} \wedge \statictype{\t_1}\K \wedge \statictype{\tp_1}\K$\\
\>$\}$
\end{tabbing}
