...
The function \ftypes\a\C\s\K returns the old references and the new types for them according to the new wrapper \C.
...
\opdef{\WFp\e\K\s}{Well-formed program}
...
\IRule[width=20em]{W3}{
  ...
  \b{\EnvType \E\s\K\ep\tp}
}{
  \EnvType \E\s\K{\Call\e\n{\b\ep}}\tpp
}    
