...
To illustrate this, we will revisit the version of our code that broke the guarded semantics, repeated
in figure~\ref{fig:trans1}. In the guarded semantics, we saw the program break in the wrapper around
A1 that made sure it acted like an A2, which occured in the invocation of test on line 9. However,
in the transient semantics, the error happens \emph{after} the invocation.
