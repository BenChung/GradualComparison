...
class D {
  that : C
  f() : A { (*@\hspace{-1.5mm}\BehStart\hspace{-1.5mm}@*)A(*@\BehEnd@*)(*@\ShaStart\hspace{-1.5mm}@*)A(*@\ShaEnd\hspace{-1.5mm}@*) this.that().f()}
  f(x : A) : A { 
    (*@\hspace{-1.5mm}\BehStart\hspace{-1.5mm}@*)A(*@\BehEnd@*)(*@\ShaStart\hspace{-1.5mm}@*)A(*@\ShaEnd\hspace{-1.5mm}@*) this.that().f( (*@\hspace{-1.5mm}\BehStart\hspace{-1.5mm}@*)A(*@\BehEnd@*)(*@\ShaStart\hspace{-1.5mm}@*)A(*@\ShaEnd\hspace{-1.5mm}@*) x)}
...
implementation of \n will violate the type guarantees imposed by \D. Under the
naive translation scheme, illustrated in the figure, the arguments to \m will be
cast to \any, then passed onwards into the untyped object. Then, the untyped
object \C will simply use its own definition of the \m method, which calls
directly into the \n method on that same object, thereby circumventing the type
applied  to it by the type cast.
