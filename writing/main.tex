...
The wrapper classes constructed during the cast mediate on the values passed
to methods of the target, and provide methods that can be accessed either
from the typed side or the untyped side.
