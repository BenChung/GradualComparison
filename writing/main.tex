...
The common core allows programs to be written with type
...
\IRule{AA3}{\GenCast{\E}{\ep1}{\ep2}{\tp 2} \\ \stcons{\tp2}{\tp1}}{\AnaCast\E{\ep1}{{\ep2}}{\tp1}}

\IRule{AA4}{\GenCast{\E}{\ep1}{\ep2}{\tp1}}{\AnaCast\E{\ep1}{\Cast{\tp1}{\ep2}}{\any}}
