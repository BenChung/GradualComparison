...
\IRule{RC1}{
  ...
  \S_1 = \Heap\S{\Bind\a\tpp} \\
  \K_1 = \K'\\
  \rectype{\a_1, \t_1, \s, \K_1, \S_1} = \S_{2}~\K_{2} ~~ \ldots ~~
  \rectype{\a_n, \t_n, \s, \K_n, \S_n} = \S_{n+1}~\K_{n+1}
}
{\rectype{\a, \t, \s, \K, \S} = \S_{n+1}, \K_{n + 1}}
