...
\SP \class ~\D ~ \{\\
\SPP \Fdef\that\C \\
\SPP \Mdefz\f\tp{~\BehCast\tp{\Call{\this.\that}\f{}}~}
&    \All f \Mtype\f{}\t\in\bmt &\wedge~ \Mtype\f{}\tp \in \bmtp
\\
\SPP \Mdef\f\x\tp\tp {~\BehCast\tp{\Call{\this.\that}\f{\BehCast\t\x}}~}
&    \All f \Mtype\f\t\t \in \bmt &\wedge~ \Mtype\f\tp\tp \in \bmtp
\\
\SPP \Mdef\m\x\t\tp {~\BehCast\tp{\Call{\this.\that}\m{\BehCast\Cp\x}}~}
&     \All m \Mtype\m\Cp\Cpp\in\bmt &\wedge~ \Mtype\m\t\tp\in\bmtp
\\
\SPP \Mdef\m\x\t\tp{~\DynCall{(\BehCast\any{\this.\that})}\m{\BehCast\any\x}~}
...
&    \All m \Mtype\m{\Cp}{\Cpp} \in \bmt &\wedge~ \Mtype\m{\t_2}{\tp_2} \not\in \bmtp
\\
\SPP \Mdef\m\x\any\any {~\DynCall{(\BehCast\any{\this.\that})}\m\x~}
...
\SP \class~\D~\{\\
\SPP \Fdef \that \C\\ 
\SPP   \Mdefz\f\any{\BehCast\any{\Call{{\this.\that}}\f{}}}
&  \All \m  \Mtype\f{}\t \in \bmt\\
\SPP   \Mdef\f\x\any\any{\BehCast\any{\Call{{\this.\that}}\f{\BehCast\t\x}}}
&  \All \f  \Mtype\m\t\t \in \bmt\\
\SPP   \Mdef\m\x\any\any{\BehCast\any{\Call{{\this.\that}}\m{\BehCast\Cp\x}}}
&  \All \m  \Mtype\m\Cp\Cpp \in \bmt\\
\SPP   \Mdef\m\x\any\any{\DynCall{(\BehCast\any{\this.\that})}\m{\BehCast\Cp\x}}
