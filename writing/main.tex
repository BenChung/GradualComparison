...
Predictably, industrial strength systems have chosen to compromise on
soundness to avoid degrading performance.\footnote{Industrial languages
  (Dart, Typescript, Hack) have unchecked modes that won't catch all type
  errors.}
...
resolved method dispatch.\footnote{Both languages support reflective method
  invocation based on the string name of the invoked method. Since C\# 4.0,
  dynamic resolution is part of the language~\cite{BAT14}. In Java,
...
\hrulefill
\begin{mathpar}
\IRule{REW1}{ }{ \rtranstz{\b{\mt}}{\b{\mtp}}\x\x }
\\
\IRule{REW2}{ \Mtype\f{}\t \in \b{\mtp} }{\rtranstz{\b{\mt}}{\b{\mtp}}{\Get\this\f}{\MonCast\t{\Get\this\f}} }

\IRule{REW3}{ \e \neq \this \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\e}{\ep} }{\rtranstz{\b{\mt}}{\b{\mtp}}{\Get\e\f}{\Get\ep\f}}

\IRule[width=20em]{REW4}{ \Mtype\f\t\t \in \b{\mt} \\ \Mtype\f\tp\tp \in \b{\mtp} \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\e}{\ep} }{\rtranstz{\b{\mt}}{\b{\mtp}}{\Set\this\f\e}{\MonCast\tp{\Set\this\f{\MonCast\t\ep}}}}

\IRule[width=20em]{REW5}{ \e_1 \neq \this \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\e_1}{\e_2} \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\ep_1}{\ep_2} }{\rtranstz{\b{\mt}}{\b{\mtp}}{\Set{\e_1}\f{\ep_1}}{\Set{\e_2}\f{\ep_2}}}

\IRule[width=25em]{REW6}{ \Mtype\m{\t_1}{\tp_1} \in \b{\mt} \\ \Mtype\m{\t_2}{\tp_2} \in \b{\mtp}  \\ 
\rtranstz{\b{\mt}}{\b{\mtp}}{\e}{\ep}}{\rtranstz{\b{\mt}}{\b{\mtp}}{\Call{\this}\m{\e}}{\MonCast{\tp_1}{\Call{\this}\m{\MonCast{\t_2}{\ep}}}}}

\IRule[width=20em]{REW7}{ \e_1 \neq \this \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\e_1}{\e_2} \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\ep_1}{\ep_2}}{\rtranstz{\b{\mt}}{\b{\mtp}}{\Call{\e_1}\m{\ep_1}}{\Call{\e_2}\m{\ep_2}}}

\IRule{REW8}{ \rtranstz{\b{\mt}}{\b{\mtp}}{\e_1}{\e_2} \\ \rtranstz{\b{\mt}}{\b{\mtp}}{\ep_1}{\ep_2}}{\rtranstz{\b{\mt}}{\b{\mtp}}{\DynCall{\e_1}\m{\ep_1}}{\DynCall{\e_2}\m{\ep_2}}}

\IRule{REW9}{ \rtranstz{\b{\mt}}{\b{\mtp}}{\b\e}{\b\ep} }{\rtranstz{\b\mt}{\b\mtp}{\New\C{\b\e}}{\New\C{\b\ep}}}
\end{mathpar}
