...
structural subtyping is not always exercised~\cite{ecoop15}. Python is
structural because the consistency relation is fundamentally structural.
Racket is structural because of it heavy use of first-class classes and
class generation.
