...
a variable annotated as a \C should behave as a \C. If not that fact must be
...
closely coupled functions that co-located in a module will not incur
...
\noindent
\figref{over} reviews type systems with publicly available
