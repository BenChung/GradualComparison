...
A behavioral cast \BehCast\t\a will return a reference \ap that behaves as
it was refering to an object of type \t. Behavioral casts are generative as
they will create a new wrapper class that ensures that the target object
abides by the interface of \t.
...
\end{mathpar}}
\caption{Behavior generative casts.}\label{behave}
\end{figure}
...
\IRule{CMS1}{
  ...
  \Kp = \K~\classgen{\Cp,\classoff\Cp\K,\classoff\D\K,\EMxt E,\K} \\
...
\IRule{TM4}{
  ...
  \Kpp = \Kp~\classgen{\C,\classoff\C\K,\b\mtpp,\EC,\Kp}\\
}{
    \tmeet\C\D\P\K = \EC\,\Kpp
}
...
&
 \All f \Mtype\f{}\t \in \bmt &\wedge& \Mtype\f{}\tp \in \bmtp
\\[1mm]
\SPP \Mdefz\f\any{\SubCast\any{\Get{\Get\this\that}\f}}
&
 \All f \Mtype\f{}\t \in \bmt &\wedge& \Mtype\f{}\tp \not\in \bmtp 
\\[1mm]
\SPP \Mdef\f\x\any\any {\SubCast\any{\Call{\Get\this\that}\f{\SubCast\any{\MonCast\t\x}}}}
& \All f \Mtype\f\t\t\in\bmt &\wedge& \Mtype\f\tp\tp\not\in\bmtp 
\\[1mm]
...
&
 ...
 &&\wedge& \statictype{\t_2}\K\cdot &\wedge& \statictype{\tp_2}\K\cdot
 \\[1mm]
\SPP \Mdef\m\x{\t_1}{\tp_1} { {\Call{\Get\this\that}\m\x}}
&
 \All m \Mtype\m{\t_1}{\tp_1} \in\bmt &\wedge& \Mtype\m{\t_2}{\tp_2} \not\in \bmtp \\
&&  \wedge& \statictype{\t_1}\K\cdot &\wedge& \statictype{\tp_1}\K\cdot\\
\}
\end{array}
\]
}
