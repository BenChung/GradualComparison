...
If $\Mtype\m{\t}\tp \in \classoff{\C}{\K}$, $\EnvType\cdot\s\K\e\C$ and (if applicable) 
...
\begin{itemize}
  ...
  \item \RuleRef{W2}
        ...
        $\Reduce \K\e\s \Kp\ep\sp$, $\WFp\Kp{\ep~\sp}$ and $\EnvType\cdot\sp\Kp\ep\tp$. 
  \item \RuleRef{W3}, \RuleRef{W4}, \RuleRef{W5}
