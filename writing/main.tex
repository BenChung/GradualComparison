...
The meet function \meet\P\K\t\tp compute the meet of types \t and \tp, it returns a new type if needed and an updated class table.
...
\begin{mathpar}
\IRule{M1}{ }{\meet\P\K\t\any = \t\,\K}

\IRule{M2}{ }{\meet\P\K\any\t = \t\,\K}
...
\IRule{M4}{
  ...
  \meet\Pp\K{\Type{\b\mt}}{\Type{\b\mtp}} = \tpp\,\Kp\\
  \Kpp = \Kp~\classgen{\C,\tpp,\EC,\Kp}\\
}{
    \meet\P\K\C\D = \EC\,\Kpp
}
...
\begin{mathpar}
\IRule{M6}{ 
}{ \meet\P\K{\b\mt}\cdot = \b\mt\,\K }

\IRule{M7}{
  \meet\P\K{\t_3}{\t_1} = {\t_5}~{\K'} \\
  \meet\P\Kp{\t_2}{\t_4} = {\t_6}~{\Kpp} \\
  \meet\P{\Kpp}{\b{\mt_1}}{\b{\mt_2}} = \b{\mt_3}~\K'''
}{
  \meet\P\K{\Mtype\m{\t_1}{\t_2}~\b{\mt_1}}{\Mtype\m{{\t_3}}{\t_4}~\b{\mt_2}} = \Mtype\m{\t_5}{\t_6}~\b{\mt_3}~\K'''
}

\IRule{M8}{
      \meet\P\K{\t_3}{\t_1} = {\t_5}~\Kp \\
      \meet\P\Kp{\t_2}{\t_4} = {\t_6}~\Kpp \\
      \meet\P\Kpp{\Type{\b{\mt_1}}}{\Type{\b{\mt_2}}} = {\Type{\b{\mt_3}}}~{\K'''}
}{
    \meet\P\K{\Type{\Mtype\f{{\t_1}}{\t_2}~\b{\mt_1}}}{\Type{\Mtype\f{{\t_3}}{\t_4}~\b{\mt_2}}} = {\Type{\Mtype\f{{\t_5}}{\t_6}~\b{\mt_3}}}~{\K'''}
}

\IRule{M9}{
      \meet\P\K{\t_2}{\t_4} = {\t_6}~\Kp \\
      \meet\P\Kp{\Type{\b{\mt_1}}}{\Type{\b{\mt_2}}} = {\Type{\b{\mt_3}}}~\Kpp
}{
    \meet\P\K{\Type{\Mtype\f{{}}{\t_2}~\b{\mt_1}}}{\Type{\Mtype\f{{}}{\t_4}~\b{\mt_2}}} = {\Type{\Mtype\f{{}}{\t_6}~\b{\mt_3}}}~\Kpp
}
\end{mathpar}
