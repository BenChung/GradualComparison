...
\newcommand{\ThrSub}[4]{\EM{#1~#2\vdash_{t} ~#3\src\Sub #4}}
\newcommand{\OKW}{\EM{~\checkmark_{t}}}
\newcommand{\EnvTypeW}[5]{ \EM{#1\,#2\,#3\vdash_{t}~ #4 : #5}}
...
\newcommand{\WFtypeW}[2]{\EM{#1\vdash_{t}~ #2 \OK}}
\newcommand{\WFW}[4]{\EM{#1\,#2\,#3\vdash_{t}~#4 \OK}}
