...
\newcommand{\moncast}[6]  {\EM{#5\;#6=\xt{moncast}(#1, #2, #3, #4)}}
...
\newcommand{\tmeet}[4]{\xt{typemeet}(#1,#2,#3,#4)}
\newcommand{\mmeet}[4]{\xt{methmeet}(#1,#2,#3,#4)}
...
\newcommand{\htype}[3]{\EM{\xt{heaptype}(#1,#2,#3)}}
\newcommand{\fieldtypes}[4]{\xt{fieldtypes}(#1,#2,#3,#4)}
