...
\newenvironment{proofy}{
	\begin{enumerate}[resume=proofsteps,label={\textbf{\arabic*}. },ref=\arabic*]
}{
	\end{enumerate}
}
\DeclareDocumentCommand\step{o}{\IfNoValueTF{#1}{\item}{\item\hypertarget{proofstep:#1}{}\label{proofstep:#1}}}
...
\newenvironment{iknown}{\begin{enumerate*}[series=proofsteps,label={\textbf{\arabic*}. },ref=\arabic*]}{\end{enumerate*}}