...
\inferrule*[right=CICall1]{
  ...
  \Gdash e.\m(\bar{e'}) \tlate e.\m(\bar{e''\cast{\t'}}):\t''
}
...
\inferrule*[right=CIIf]{
  ...
  \Gdash \ifthenelse{e_1}{e_2}{e_3} \tlate \ifthenelse{e_1'\cast{\int}}{e_2'}{e_3'} : \t_2
} 
...
\inferrule*[right=CIPlus]{
  ...
  \Gdash e_1 + e_2 \tlate e_1'\cast{\int} + e_2' \cast{\int}:\int 
}
...
\inferrule*[right=CINew]
      {\C=\{\bar{\f :\t},\ldots\} \in \G \\ 
       \bar{\Gdash e \tlate e' : \t'} \\ 
        \bar{\t \sim \t'}}
      {\Gdash \NEW \C{\bar e} \tlate \NEW\C{\bar{e'\cast{\t}}} : \C}
\end{mathpar}
...
\inferrule*[right=HRObj]{
       ...
       \t' = \{ \bar{ \f : \t_2}, \bar{\m (\bar{ x:\t_2''}):\t_2'} \}\\
        o' =    \{\bar{\f= v'\cast{\t_1\coerce\t_2}}, 
     \bar{\m (\bar x) = \this.\m'(\bar{ x \cast{\t_2''\coerce\t_1''}}), \m'(\bar x) = e\cast{\t_1'\coerce \t_2'}}\}
}{
   \{\bar{\f=v'}, \bar{\m(\bar x) = e}\}\cast{\t\coerce\t'},\sc \heapreduce o',\sc
}
\end{mathpar}
State reduction:
\begin{mathpar}
...
\inferrule*[]{ e,\s\ereduce e',\sc }{ e,\s \longrightarrow e',\sc}
 ...
 \inferrule*[]{
 	\sc(a) = co : \t\\
 	co,\sc \heapreduce co',\sc'\\
 	\sc'(a)_{rtti} = \t\\
 }{
 	e,\sc \longrightarrow e,\sc'(a \is co' : \t)
 }
