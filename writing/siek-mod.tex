...
\begin{mathpar}
\inferrule*[lab=CSSim]{ }{ \t \lesssim \t }

\inferrule*[lab=CSSub]{\C <: \xt{D}}{ \C \lesssim \xt{D} }

\inferrule*[lab=CSCons]{ \t \sim \t'}{\t \lesssim \t'}

\inferrule*[lab=CSTrans]{ \t \lesssim \t' \\ \t' \lesssim \t''}{\t \lesssim \t''}
\end{mathpar}
...
classMeet is applied to every string of classes $C_1,\ldots,C_n$.
\end{document}
