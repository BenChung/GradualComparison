...
\newcommand{\MonStart}{\EM{\triangleleft}}
\newcommand{\MonEnd}{\hspace{-2px}\EM{\triangleright}}
\newcommand{\MonCast}[2]{\EM{\MonStart\, #1\, \MonEnd #2}}
\newcommand{\typegen}[2]{\xt{ifcgen}(#1,#2)}
...
\newcommand{\mmeet}[4]{\xt{meet}(#1,#2,#3,#4)}
\newcommand{\tmeet}[4]{\xt{meet}(#1,#2,#3,#4)}
\newcommand{\classgen}[1]{\xt{wrap}(#1)}
