...
\kafka allows us to demonstrate that notion of type error depends on the
approach selected.  Each of the gradual type approaches will catch different
...
\item A proof of soundness, mechanized in Coq, demonstrating that \kafka
  programs are respect the \kafka type system. The main challenge of that
  proof was




  The \kafka object-oriented calculus for gradual typing, providing a
