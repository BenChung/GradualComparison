...
type systems for a vast array of languages have been developed~\cite{CITEME},
enabling programmers to type untyped code gradually. Each of these approaches
devotes great care and attention to getting typing for that language correct,
...
~\cite{CITEME}, provide excellent performance, but suffer from reduced
...
a sea of language-specific detail, making direct comparison difficult.
...
In this paper, we propose a sound core calculus for evaluating gradual type
systems for object oriented-languages, called \kafka, and present translations
from a common source syntax to \kafka, illustrating the key differences between
four approaches to gradual typing for objects, and use this common framework to 
directly compare gradual type systems for objects in the same setting.
