...
\subsubsection{Invocations}
    ...
    and the typed invocation $\KCall\e\m\ep{\t}{\tp}$, both denoting a typed call to a
    method $\m$ with argument \ep. Unusually, the typed form also specifies the
    argument type (\t) and return type (\tp), enabling a key simplification.
