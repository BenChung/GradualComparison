...
language \footnote{Details of our source language appear in section 5}. 
All of these programs type check according to each of the four gradual type systems, and
...
implemented the litmus test in Typescript (optional), Thorn (concrete), 
Typed Racket (behavioral), and Transient Reticulated Python (transient). 
These implementations are included in the appendix}.

Each program of the litmus test consists of class definitions and a main expression.

\begin{itemize}
	\item Litmus test 1 (L1) contains three classes, \texttt{A}, \texttt{I}, and \texttt{T}. The main expression for litmus test 1 invokes the method \t of class \texttt{T}.
	\item Litmus test 2 (L2) contains four classes,
	\item Litmus test 3 (L3) contains
\end{itemize}
