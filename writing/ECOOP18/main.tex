...
type annotations at runtime; all three programs run to completion without
error.
...
used, but the test does not describe the semantics of the gradual type systems
it differentiates. To fully describe the semantics of these systems, we define
a formal semantics. This semantics is comprised of a source language, a target
language, and translations that bridge them. Gradually-typed programs written
in the common source language are translated according to each gradual type
system into the common target language. We discuss our common target language,
\kafka, next.
