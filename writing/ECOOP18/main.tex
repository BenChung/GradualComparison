...
\section{Source Language and Litmus test}\label{litmustest}
...
determine what kind of type system is being used. Using this property, we
propose a litmus test that can distinguish the four gradual type system
approaches of optional, concrete, behavioral, and transient.
...
given in \figref{f:sourcesyntax}. This defines a simple object calculus
...
The type system of \figref{fig:slts} is a standard static semantics for
...
\RuleRef{STGC-TOANY} and \RuleRef{STGC-ANYCONC}). To avoid collapsing the
...
\RuleRef{STGC-ANYCONC} is used, then an untyped value is being passed into
...
\paragraph{Acknowledgments} The author thank the reviewers of ECOOP, POPL,
...
Felleisen for their feedback.  This work was funded ... nsf gradual... erc...  onr... darwin...
