...
simple, through the identity function, but the lack of wrappers means that
untyped code has direct access to typed values, unlike the behavioral
semantics. To solve this, we use overloading (discussed previously in
section 4), generating both typed and untyped variants of a method.
