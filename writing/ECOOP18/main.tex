...
individual lambda calculus terms through a consistency relation, and inserts
casts based on a simple type inference system \cite{SiekTaha06}. The second,
by Tobin-Hochtstat and Felleisen, adds types to entire Scheme modules, using
constraint solving to find where casts must be added in untyped
code~\cite{tf-dls06}. These two quite different solutions, targeting
different languages, set the trend for the next ten years of
