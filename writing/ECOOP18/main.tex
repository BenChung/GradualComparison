...
gradual type systems, they display different errors.  The significance of this
...
The type system for the source language, shown in figure~\ref{fig:slts}, is a
...
convertibility operator is shown in figure~\ref{fig:tyconvert}. The operator
...
Convertibility and assert translation, shown in figure~\ref{fig:trtype}, have
...
figure~\ref{fig:traclass}, calls for all types to be erased from methods while
