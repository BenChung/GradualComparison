...
languages look very different. As a result, these differences between gradual
type systems are hard to find, hidden among major presentation and semantic
differences  that are irrelevant to gradual typing itself.
