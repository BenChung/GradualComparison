...
Underlying each of the subsequent gradual type systems for objects are
different choices on how to deal with state and aliasing -- often with key
differences in soundness property and enforcement. These fundamental details
are obscured by target language features.


In addition to standardizing the target language, the source language must
be equally held constant, reducing the point of comparison to the
translation alone.
