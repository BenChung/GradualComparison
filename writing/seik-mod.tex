...
\inferrule*[]{\Gamma \vdash e \tlate e' : \{\ldots, l(\overline{\tau}):\tau', \ldots\} \\ \overline{\Gamma \vdash e_a \tlate e_a' : \tau_a} \\ \overline{\tau \sim \tau_a} \\ \overline{(\tau_a \Rightarrow{\tau}) = c}}{\Gamma \vdash e.l(\overline{e_a}) \tlate e.l(\overline{e_a'\cast{c}}) : \tau'}

\inferrule*[]{ \Gamma \vdash e \tlate e' : \anyt \\  \overline{\Gamma \vdash e_a \tlate e_a' : \tau_a} \\ \anyt \Rightarrow \{l(\overline{\tau_a}):\anyt\} = c}{\Gamma \vdash e.l(\overline{e_a}) \tlate e'\cast{c}.l(\overline{e_a'}) : \anyt }
...
\inferrule*[]{C=\{\overline{\xt{f}:\tau},\ldots\} \in \Gamma \\ \overline{\Gamma \vdash e \tlate e' : \tau'} \\ \overline{\tau \sim \tau'}}{\Gamma \vdash \xt{new } C(\overline{e}) \tlate \xt{new }C(\overline{e'\cast{\tau' \Rightarrow \tau}}) : C}
\end{mathpar}
