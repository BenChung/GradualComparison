...
I &::= \strt | \intt | \{\overline{\xt{f}:\tau},\overline{\xt{m}(\overline{\tau}):\tau}\}\\
c &::= \iota | I? | I! | \{\overline{\xt{f}\cast{c}}, \overline{\xt{m}(\overline{\xt{f}\cast{c}}):c}\}\\
cv &::= v | v\cast{c} | \{\overline{\xt{f}\cast{c}=v},\overline{\xt{m}(\overline{l\cast{c}})\cast{c}=e}\}\\
...
\inferrule*[]{ \mu[a\mapsto \{\ldots,\xt{m}(\overline{f})=e\}] }{ a.\xt{m}(\overline{v}),\mu \expreduce [a/\xt{this}][\overline{v/f}]e,\mu}
