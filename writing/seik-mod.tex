...
\inferrule*[]{
v(a) = \{\overline{\xt{f} = v}, \overline{\xt{m}(\overline{\xt{p}\cast{c}}) = e}\} : \tau \\ 
...
}{ a\cast{\tau'},\cstctx \castreduce a,\cstctx(a\mapsto \{\overline{\xt{f} = v\cast{\tau_i \Rightarrow \tau_f}}, \overline{
\xt{m}(\overline{\xt{ip} : \tau_{p}}) = \texttt{this}.m'(\overline{\xt{ip}\cast{\tau_{p} \Rightarrow \tau_{ip}}}),
\xt{m'}(\overline{\xt{p} : \tau_{ip}}) = e\cast{\tau_{im} \Rightarrow \tau_m}
}\})}

\inferrule*[]{
\mu(a) = \{\overline{\xt{f} = v}, \overline{\xt{m}(\overline{\xt{p}\cast{c}}) = e}\} : \tau \\ \tau \sqcap \tau'
